...
`, es = sn(function({ zoom: r, rows: t, data: n, onTileClick: o }, s) {
  ...
  return me(() => {
    ...
    /* @__PURE__ */ D(Qo, { ref: p }),
    /* @__PURE__ */ D(Oi, { data: n, zoom: r, onTileClick: o }),
...
`, xs = () => {
  ...
  return /* @__PURE__ */ ae(ws, { children: [
    /* @__PURE__ */ D(gs, {}),
...
`, yr = {
...
}, $s = ({ data: e, onTileClick: r, onItemClick: t, topBarWidth: n }) => {
  ...
  return me(() => {
    ...
    /* @__PURE__ */ ae(Ss, { children: [
      /* @__PURE__ */ D(Si, { zoom: p, topBarWidth: n }),
      e.length ? /* @__PURE__ */ D(
        es,
        {
          data: F,
      ...
      l && (o == null ? void 0 : o.resourceIndex) > -1 && /* @__PURE__ */ D(Wi, { tooltipData: o, zoom: p })
    ] })
  ] });
}, rn = `
  background: none;
...
`, Ts = ({ width: e }) => {
  ...
  return /* @__PURE__ */ ae(Es, { width: e, children: [
    /* @__PURE__ */ D(Ps, { children: y >= 0 && /* @__PURE__ */ ae(
      wt,
      {
...
`, Fi = ({
  ...
  return me(() => {
    ...
    /* @__PURE__ */ D(io, {}),
    /* @__PURE__ */ D(ro, { theme: de, children: /* @__PURE__ */ D(ys, { lang: c.lang, children: /* @__PURE__ */ D(
      qo,
      {
        data: e,
        isLoading: !!l,
...
`, wr = ({
  ...
  return /* @__PURE__ */ D(Gs, { intent: e, children: /* @__PURE__ */ ae(Us, { onClick: r, isVisible: n, children: [
    t && /* @__PURE__ */ D(Xs, { children: t }),
    /* @__PURE__ */ D(qs, { children: l })
  ] }) });
}, Js = z.div`
  min-width: ${Oe + "px"};
  max-width: ${Oe + "px"};
...
`, br = z.p`
  ...
  white-space: nowrap;
  overflow: hidden;
`, ii = ({ id: e, item: r, rows: t, onItemClick: n }) => /* @__PURE__ */ D(
  ti,
  {
    ...
    children: /* @__PURE__ */ ae(ri, { children: [
      /* @__PURE__ */ D(ni, { children: r.icon ? /* @__PURE__ */ D(oi, { src: r.icon, alt: "Icon" }) : /* @__PURE__ */ D($e, { iconName: "defaultAvatar" }) }),
  ...
  return /* @__PURE__ */ ae(Js, { children: [
    /* @__PURE__ */ ae(Ks, { children: [
      /* @__PURE__ */ ae(ei, { isFocused: c, children: [
        /* @__PURE__ */ D(
          Qs,
          {
            placeholder: m,
...
`, di = ({ isLoading: e, position: r }) => e ? /* @__PURE__ */ D(ci, { position: r, children: /* @__PURE__ */ D(ui, {}) }) : null, xr = di, hi = de.colors.white, Xe = (e) => {
  const {
    ctx: r,
    x: t,
    y: n,
  ...
  if (r.beginPath(), r.strokeStyle = de.colors.grey400, r.setLineDash([]), a && l && i) {
    r.fillStyle = hi, r.fillRect(t, n, o, s), r.strokeRect(t + 0.5, n + 0.5, o, s), r.font = l;
  ...
  r === 0 ? (gi(e, n, s), pi(e, t, n), yi(e, t, n, o)) : (mi(e, n), vi(e, n, o), fi(e, t, n));
}, bi = z.div`
  position: sticky;
  top: 0;
  z-index: 1;
...
`, Ci = z.canvas``, Si = ({ zoom: e, topBarWidth: r }) => {
  ...
  return me(() => {
    ...
    u && l(u);
  }, [n, e, l]), /* @__PURE__ */ ae(bi, { children: [
    /* @__PURE__ */ D(Ts, { width: r }),
    /* @__PURE__ */ D(xi, { id: lo, children: /* @__PURE__ */ D(Ci, { ref: a }) })
  ] });
}, $i = (e, r, t) => {
  const n = t === 0 ? Me : pe, o = () => {
...
`, Ti = z.div`
  ...
  left: ${Oe + 16}px;
  overflow: hidden;
`, Ri = ({ row: e, data: r, zoom: t, onTileClick: n }) => {
  const { date: o } = Ge(), s = ht(o, t), { y: i, x: a, width: l } = Ei(
    e,
    s.startDate,
    s.endDate,
    r.startDate,
  ...
  return /* @__PURE__ */ D(
    Mi,
    {
      ...
      children: /* @__PURE__ */ D(_i, { children: /* @__PURE__ */ ae(Ti, { children: [
        /* @__PURE__ */ D(Cr, { bold: !0, children: r.title }),
        /* @__PURE__ */ D(Cr, { children: r.subtitle }),
        /* @__PURE__ */ D(Pi, { children: r.description })
      ] }) })
    }
  );
}, Ai = ({ data: e, zoom: r, onTileClick: t }) => {
  const n = ye(() => {
    let o = 0;
...
`, Wi = ({ tooltipData: e, zoom: r }) => {
  ...
  }, [s.x, l, i.overtime, s.y]), /* @__PURE__ */ ae(Di, { ref: a, children: [
    /* @__PURE__ */ D(Ii, { children: /* @__PURE__ */ ae(Li, { children: [
      /* @__PURE__ */ ae(Sr, { children: [
        ...
        /* @__PURE__ */ ae($r, { children: [
          ...
          (i.overtime.hours > 0 || i.overtime.minutes > 0) && /* @__PURE__ */ ae(Zt, { children: [
            ...
            "-",
            " ",
            /* @__PURE__ */ D(Zi, { children: `${i.overtime.hours}h ${i.overtime.minutes}m ${o}` })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ ae(Sr, { children: [
