...
var me = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ct = {}, xn = {
  get exports() {
    return ct;
  },
  set exports(e) {
...
function Mn(e) {
  function n(S, M, C, Y, h) {
    for (var X = 0, b = 0, J = 0, U = 0, K, g, ce = 0, N = 0, ee, le = ee = K = 0, re = 0, ue = 0, nt = 0, fe = 0, ht = C.length, ot = ht - 1, Me, q = "", de = "", St = "", Mt = "", Pe; re < ht; ) {
      if (g = C.charCodeAt(re), re === ot && b + U + J + X !== 0 && (b !== 0 && (g = b === 47 ? 10 : 47), U = J = X = 0, ht++, ot++), b + U + J + X === 0) {
        if (re === ot && (0 < ue && (q = q.replace(f, "")), 0 < q.trim().length)) {
          switch (g) {
            case 32:
            case 9:
            case 59:
          ...
          case 123:
            ...
            switch (ee = C.substring(fe, re), K === 0 && (K = (q = q.replace(u, "").trim()).charCodeAt(0)), K) {
              case 64:
                ...
                if (ee = n(M, ue, ee, g, h + 1), fe = ee.length, 0 < W && (ue = t(V, q, nt), Pe = c(3, ee, ue, M, P, te, fe, g, h, Y), q = ue.join(""), Pe !== void 0 && (fe = (ee = Pe.trim()).length) === 0 && (g = 0, ee = "")), 0 < fe)
                  switch (g) {
                    case 115:
                      q = q.replace(_, s);
                    case 100:
                ...
                break;
              default:
                ee = n(M, t(M, q, nt), ee, Y, h + 1);
            }
            St += ee, ee = nt = ue = le = K = 0, q = "", g = C.charCodeAt(++re);
            break;
          case 125:
          case 59:
            ...
            nt = ue = le = K = 0, q = "", g = C.charCodeAt(++re);
        }
      }
      switch (g) {
        case 13:
...
`;
...
}(), vt = /* @__PURE__ */ new Map(), wt = /* @__PURE__ */ new Map(), at = 1, ft = function(e) {
  if (vt.has(e))
    return vt.get(e);
  for (; wt.has(at); )
    at++;
  ...
  n >= at && (at = n + 1), vt.set(e, n), wt.set(n, e);
...
function We(e, n, t, r) {
  ...
  if (Xe(e)) {
    if (typeof (a = e) != "function" || a.prototype && a.prototype.isReactComponent || !n)
      return e;
    var l = e(n);
    return process.env.NODE_ENV !== "production" && ct.isElement(l) && console.warn(Ot(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), We(l, n, t, r);
  }
  var a;
...
var It = function(e) {
  return function n(t, r, o) {
    if (o === void 0 && (o = Re), !ct.isValidElementType(r))
...
const F = It, it = "reactSchedulerOutsideWrapper", xo = wo`
...
F.div`
  ...
  height: 40vh;
`;
const be = 50, Te = 24, tt = 16, Ne = 40, Ke = Ne + tt + Te, Le = 84, Ce = 56, Se = 196, ke = 12, ge = 50, Qe = 24, lt = 16, Yt = 40, Mo = Qe + lt + Yt, kr = 24, Er = 52, $e = {
...
}, Ue = 3, _o = 1.6, $o = 4.5, Nt = 12, xt = 24, ko = "reactSchedulerCanvasHeaderWrapper", on = "reactSchedulerCanvasWrapper", Ze = it, Eo = 4, To = 48, Oe = 5, Do = 40, Tr = 8, sr = Te / 2 + 2, sn = tt / 2 + Te + 1, Dr = 2, he = 60;
var Fe = {}, Po = {
  get exports() {
    return Fe;
  },
...
var Ve = as;
const yt = [0, 1, 2];
var dt = /* @__PURE__ */ ((e) => (e[e.Tour = 0] = "Tour", e[e.Transfer = 1] = "Transfer", e))(dt || {});
...
`, ys = bn(function({ zoom: n, rows: t, data: r, onTileClick: o }, i) {
  ...
  return {
    ...
    reservationData: {
      ...
      endDate: e.eventType === dt.Tour ? R(e.endDate).format("hh:mm A") : void 0,
...
`, Et = {
  ...
  reservationData: { startTime: "", client: "", eventName: "", reservationType: dt.Tour, bookingNumber: "" }
}, ni = ({
  data: e,
  onTileClick: n,
  onItemClick: t,
...
`, Ir = ({
  ...
  const { loadNext: s, loadPrevious: c } = ut(), l = e === "next" ? `${s} ${o + 2}/${i}` : `${c} ${o}/${i}`;
...
`, ji = ({ id: e, item: n, rows: t, onItemClick: r }) => /* @__PURE__ */ E(
  ...
  const [a, d] = ve(!1), { search: u } = ut(), f = () => d((v) => !v);
...
`, aa = F.canvas``, ca = ({ zoom: e, topBarWidth: n, showThemeToggle: t, toggleTheme: r }) => {
  const { week: o } = ut(), { date: i, cols: s, dayOfYear: c, startDate: l } = rt(), a = we(null), d = je(), u = xe(
    (f) => {
  ...
  return Zr(() => {
    ...
    /* @__PURE__ */ E(ba, { children: /* @__PURE__ */ ae(Ca, { children: [
      ...
      /* @__PURE__ */ ae(st, { children: [
        ...
        e.reservationData.reservationType === dt.Tour && /* @__PURE__ */ E(Be, { children: /* @__PURE__ */ E(ze, { children: `Finaliza: ${e.reservationData.endDate}` }) })
      ] }),
      /* @__PURE__ */ ae(st, { children: [
        /* @__PURE__ */ E(ye, { iconName: "subtract", height: "12" }),
        /* @__PURE__ */ E(Be, { children: /* @__PURE__ */ E(ze, { children: e.reservationData.eventName }) })
      ] }),
      e.reservationData.reservationType === dt.Transfer && !!e.reservationData.groupName && /* @__PURE__ */ ae(st, { children: [
        /* @__PURE__ */ E(ye, { iconName: "subtract", height: "12" }),
