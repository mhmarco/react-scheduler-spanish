    ...
    /* @__PURE__ */ F(
      Mi,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ h(Dd, { zoom: r, startDate: w }),
          /* @__PURE__ */ h(
            Al,
            {
              data: n,
...
const xa = ({
  ...
  const [C, v] = pe(ya), [k, p] = pe(e), [R, G] = pe(!1), [L, T] = pe(!1), [u, g] = pe(""), [w, E] = pe(/* @__PURE__ */ new Set()), [b, D] = pe(/* @__PURE__ */ new Set()), z = fe([]);
  ...
  const {
    ...
    const ie = va(B, Z), ce = ((Z == null ? void 0 : Z.length) ?? 0) > 0, de = /* @__PURE__ */ new Map();
  ...
  return be(() => {
    ...
    /* @__PURE__ */ F(pa, { children: [
      ...
      N && /* @__PURE__ */ h(Vl, { tooltipData: C, visible: R && !L })
    ] })
  ] });
}, ba = x.div`
  width: 100%;
...
`, Ea = x.span`
  ...
  padding: 0 4px;
  margin-left: 2px;
`, ht = ({ children: e, sw: r = 2 }) => /* @__PURE__ */ h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: r, strokeLinecap: "round", strokeLinejoin: "round", children: e }), _a = () => {
  var r, t;
  ...
  return /* @__PURE__ */ F(ba, { width: 0, children: [
    /* @__PURE__ */ F(yr, { $at: "start", children: [
      ...
      /* @__PURE__ */ h(Ma, { children: r.locale(A.locale()).format("MMMM YYYY") }),
      /* @__PURE__ */ h(wa, {}),
      /* @__PURE__ */ F(ka, { children: [
      ...
      e.showJumpToDate !== !1 && /* @__PURE__ */ F($a, { children: [
      ...
      /* @__PURE__ */ F(Da, { onClick: f, children: [
        /* @__PURE__ */ F(ht, { children: [
    ...
    /* @__PURE__ */ F(yr, { $at: "end", children: [
      e.showFilterButton !== !1 && d >= 0 && /* @__PURE__ */ F(xr, { $primary: !!d, onClick: l, children: [
        ...
        "Filtros",
        !!d && /* @__PURE__ */ h(Ea, { children: d })
      ] }),
      e.showFullscreenButton !== !1 && /* @__PURE__ */ F(xr, { onClick: _a, children: [
...
x.button`
  ...
  ${({ theme: e, variant: r, disabled: t }) => Va(e, r, t)}
`;
const Ga = x.div`
  position: absolute;
  left: 0;
  ...
  return /* @__PURE__ */ F(Ga, { children: [
    ...
    /* @__PURE__ */ F(
      Ua,
      {
        ...
        onMouseLeave: () => l(null),
        children: [
          /* @__PURE__ */ h(Ka, { children: p.map((b, D) => /* @__PURE__ */ h("span", { style: { left: `${v(b)}%` }, children: D === 0 || b.month() === 0 ? `${a[b.month()]} ${b.format("YY")}` : a[b.month()] }, D)) }),
          p.map(
            (b, D) => D === 0 ? null : /* @__PURE__ */ h(Ja, { style: { left: `${v(b)}%` } }, D)
          ),
          /* @__PURE__ */ h(qa, { children: G.map((b, D) => /* @__PURE__ */ h(Qa, { $sev: b.sev, style: { height: `${b.h}%` } }, D)) }),
          /* @__PURE__ */ h(tc, { style: { left: `${u.left}%`, width: `${u.width}%` } }),
          /* @__PURE__ */ h(ec, { style: { left: `${k(L)}%` }, children: /* @__PURE__ */ h("span", { children: "HOY" }) }),
          c && g && /* @__PURE__ */ F(Oe, { children: [
            /* @__PURE__ */ h(nc, { style: { left: `${g.left}%`, width: `${g.width}%` } }),
            /* @__PURE__ */ h(rc, { style: { left: `${c.left}%` } }),
            /* @__PURE__ */ h(oc, { style: { left: `${c.left}%` }, children: `Ir a ${w(c.d)}` })
          ] })
        ]
      }
    )
  ...
  return Vr(
    ...
    /* @__PURE__ */ h(Ms, { theme: P, children: /* @__PURE__ */ h(ca, { lang: T.lang, translations: T.translations, children: /* @__PURE__ */ h(
      xi,
      {
        ...
        onClearFilterData: a,
        toolbarActions: d,
        children: /* @__PURE__ */ F(ic, { id: uo, children: [
          /* @__PURE__ */ h(
            ac,
            {
              showScroll: !!r.length,
          ...
          T.showOverview !== !1 && !!r.length && /* @__PURE__ */ h(sc, {})
        ] })
      }
    ) }) })
  ] });
...
`, br = ({
  ...
  return /* @__PURE__ */ h(dc, { intent: e, children: /* @__PURE__ */ F(uc, { onClick: r, isVisible: n, children: [
...
`, Sr = x.p`
  ...
  white-space: nowrap;
  overflow: hidden;
`, Dc = (e) => !!e && /^(https?:|data:|blob:|\/)/.test(e), Ec = () => /* @__PURE__ */ F("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: [
...
] }), _c = () => /* @__PURE__ */ F("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", children: [
...
] }), Tc = ({ id: e, item: r, rows: t, onItemClick: n, isSubcontract: o }) => /* @__PURE__ */ h(
  Sc,
  {
    title: r.title,
    ...
    children: /* @__PURE__ */ F(Cc, { children: [
      /* @__PURE__ */ h(Mc, { $provider: o, children: Dc(r.icon) ? /* @__PURE__ */ h(kc, { src: r.icon, alt: "" }) : o ? /* @__PURE__ */ h(_c, {}) : /* @__PURE__ */ h(Ec, {}) }),
...
`, Cr = ({
  ...
  onToggle: n,
  variant: o = "category"
}) => /* @__PURE__ */ F(Ac, { $variant: o, onClick: n, title: e, children: [
  /* @__PURE__ */ h(Ic, { $collapsed: t, children: /* @__PURE__ */ h("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ h(
    "path",
    {
  ...
  /* @__PURE__ */ h(Pc, { $variant: o, children: e }),
  /* @__PURE__ */ h(Oc, { $variant: o, children: r })
] }), Yc = ({
  data: e,
  categories: r,
  headerHeight: t,
  ...
  return /* @__PURE__ */ F(pc, { children: [
    /* @__PURE__ */ F(mc, { $height: t, children: [
      /* @__PURE__ */ F(gc, { children: [
        /* @__PURE__ */ F(vc, { isFocused: R, children: [
          /* @__PURE__ */ h(
            yc,
            {
...
`, Bc = ({ isLoading: e, position: r }) => e ? /* @__PURE__ */ h(Rc, { position: r, children: /* @__PURE__ */ h(Nc, {}) }) : null, Tn = Bc, qe = (e, r) => {
  const {
    ctx: t,
    x: n,
    y: o,
    ...
    qe(
      {
        ...
        fillStyle: f ? o.colors.today + "26" : jc({ isCurrent: f, variant: "yearView" }, o),
        topText: {
          y: s,
  ...
  switch (r) {
    case 0:
      Vc(e, n, s, i), zc(e, t, n, i), Zc(e, t, n, o, i);
      break;
    case 1:
      Fc(e, n, i), Wc(e, n, o, i), Hc(e, t, n, i);
      break;
    case 2:
      Xc(e, t, n, i), Gc(e, t, n, i), Uc(e, t, n, i);
      break;
  }
}, Jc = x.div`
  position: sticky;
...
`, cl = [
  ...
  cl.map((e) => /* @__PURE__ */ F(sl, { children: [
    /* @__PURE__ */ h(il, { style: { background: e.stripe } }),
    /* @__PURE__ */ h(al, { style: { color: e.color }, children: /* @__PURE__ */ h(Ze, { name: e.icon, strokeWidth: e.icon === "check" ? 2.6 : 2.2 }) }),
    e.label
  ] }, e.label))
] }), dl = Pn(function({ zoom: r, topBarWidth: t, showThemeToggle: n, toggleTheme: o }, s) {
  const { week: i } = Je(), { date: c, cols: l, dayOfYear: a, startDate: d, config: f } = Ke(), y = fe(null), C = qt(), v = le(
    (k) => {
      const p = Wn(), G = (r === 2 ? Ts : wt) + 1;
      go(k, p, G), Kc(k, r, l, d, i, a, C);
    },
    [l, a, d, i, r, C]
  );
  return be(() => {
    ...
    p && v(p);
  }, [c, r, v]), /* @__PURE__ */ F(Jc, { ref: s, children: [
    (f.showTopbar !== !1 || f.showLegend !== !1) && /* @__PURE__ */ F(qc, { $width: t, children: [
      f.showTopbar !== !1 && /* @__PURE__ */ h(Ta, { width: t, showThemeToggle: n, toggleTheme: o }),
      f.showLegend !== !1 && /* @__PURE__ */ h(ll, {})
    ] }),
    /* @__PURE__ */ h(Qc, { id: Os, children: /* @__PURE__ */ h(el, { ref: y }) })
  ] });
}), ul = (e, r, t) => {
  let n;
  switch (t) {
...
`, ml = x.button`
  ...
  ${({ $exiting: e }) => e && Mt`
      ...
      pointer-events: none;
      @media (prefers-reduced-motion: no-preference) {
        animation: ${pl} 190ms ease-out forwards;
      }
    `}
`, gl = x.span`
  position: absolute;
...
`, Ml = 34, kl = {
  ...
  const { date: d } = Ke(), f = Qt(d, t), { y, x: C, width: v } = fl(
    e,
    f.startDate,
    f.endDate,
    r.startDate,
    ...
    width: `${v}px`,
    color: So(r.bgColor ?? "")
  }, E = !n && r.readiness ? kl[r.readiness] : null, b = n && r.subcontractConfirmed === !1, D = n ? b ? Dl : $l : E == null ? void 0 : E.stripe, z = (q) => /* @__PURE__ */ F(
    ml,
    {
      ...
      $exiting: a,
      children: [
        D && /* @__PURE__ */ h(gl, { style: { background: D } }),
        q
      ]
    }
  );
  return z(
    T ? /* @__PURE__ */ F(Oe, { children: [
      ...
      /* @__PURE__ */ F(Cl, { $transfer: L, children: [
        /* @__PURE__ */ h(Ze, { name: L ? "transfer" : "sun", strokeWidth: 2.4 }),
        v >= Ml && /* @__PURE__ */ F(Oe, { children: [
      ...
      /* @__PURE__ */ F(yl, { children: [
        /* @__PURE__ */ F(kr, { $pad: !0, children: [
          /* @__PURE__ */ h(vl, { children: /* @__PURE__ */ h(Ze, { name: L ? "transfer" : "tour" }) }),
          /* @__PURE__ */ h(xl, { children: r.title })
        ] }),
        r.subtitle && /* @__PURE__ */ h(kr, { children: /* @__PURE__ */ h(bl, { children: r.subtitle }) }),
        r.driver && /* @__PURE__ */ F(Sl, { children: [
...
const Zl = {
  ...
  oneDay: "One-day",
  passengers: "Pax"
}, Vl = ({ tooltipData: e, visible: r = !0 }) => {
  const { mouseCoords: t, reservationData: n } = e, o = fe(null), [s, i] = pe("below"), c = Je(), l = { ...Zl, ...c.tooltip };
  Jt(() => {
    if (!o.current || !t)
      return;
  ...
  return /* @__PURE__ */ F(Pl, { ref: o, $position: s, $visible: r, children: [
    /* @__PURE__ */ F(Ol, { children: [
      /* @__PURE__ */ F(Il, { children: [
        /* @__PURE__ */ h(Yl, { children: n.bookingNumber }),
        /* @__PURE__ */ h(Rl, { $type: f(), children: y() })
      ] }),
      /* @__PURE__ */ h(Ll, { children: n.eventName }),
      n.client && /* @__PURE__ */ h(Nl, { children: n.client })
    ] }),
    /* @__PURE__ */ F(Bl, { children: [
      ...
      C.length > 0 && /* @__PURE__ */ h(zl, { children: C.map((v, k) => /* @__PURE__ */ F(Fl, { children: [
        /* @__PURE__ */ h(Wl, { children: v.label }),
        /* @__PURE__ */ h(jl, { children: v.value })
      ] }, k)) }),
  ...
  return /* @__PURE__ */ F(Gl, { children: [
    ...
    /* @__PURE__ */ h(
      Xl,
      {
        ...
        children: /* @__PURE__ */ h(Ul, { children: /* @__PURE__ */ F(Jl, { children: [
          /* @__PURE__ */ h(Nr, { $bold: !0, children: e.title }),
          e.subtitle && /* @__PURE__ */ h(Nr, { children: e.subtitle }),
          e.description && /* @__PURE__ */ h(Kl, { children: e.description })
        ] }) })
      }
    )
  ] });
...
`, gd = ({ selections: e, onConfirm: r, onClear: t }) => {
  ...
  if (e.length === 0)
    return null;
  const y = s > 0, C = /* @__PURE__ */ F(dd, { $hasConflicts: y, "data-multi-select-ui": !0, children: [
    /* @__PURE__ */ F(ud, { children: [
      /* @__PURE__ */ F(fd, { $hasConflicts: y, children: [
        e.length,
        " ",
        i
      ] }),
      y && /* @__PURE__ */ F(hd, { children: [
        "⚠️ ",
        f
      ] }),
      /* @__PURE__ */ h(pd, { children: c })
    ] }),
    /* @__PURE__ */ F(md, { children: [
  ...
  return be(() => {
    ...
    return /* @__PURE__ */ F(
      xd,
      {
        ...
        children: [
          w && /* @__PURE__ */ h(wd, { title: p(g.selection), children: "⚠️" }),
          /* @__PURE__ */ h(bd, { $hasConflict: w, children: k(g.selection.startDate, g.selection.endDate) }),
          /* @__PURE__ */ h(
            Sd,
            {
              onClick: (z) => {
...
`, $d = ({ zoom: e, startDate: r }) => {
  ...
  return n ? /* @__PURE__ */ h(kd, { style: { left: `${n.x}px`, width: `${n.width}px` }, "aria-hidden": !0 }) : null;
}, Dd = $d;
export {
  Pd as Scheduler
};
