...
`,Aa=b.p`
  ...
  width: 100%;
  text-align: center;
`,Nr=({intent:e,onClick:r,icon:t,isVisible:n,pageNum:o,pagesAmount:s})=>{const{loadNext:a,loadPrevious:l}=Ze(),d=e==="next"?`${a} ${o+2}/${s}`:`${l} ${o}/${s}`;return i.jsx(Ea,{intent:e,children:i.jsxs(_a,{onClick:r,isVisible:n,children:[t&&i.jsx(Ta,{children:t}),i.jsx(Aa,{children:d})]})})},Pa=b.div`
  min-width: ${Pe+"px"};
  max-width: ${Pe+"px"};
  min-height: 100vh;
  position: sticky;
...
`,Fr=b.div`
  ${({$fading:e})=>e&&st`
      ...
      @media (prefers-reduced-motion: no-preference) {
        animation: ${Na} 180ms ease forwards;
      }
    `}
`,Fa=b.button`
  display: flex;
...
`,Br=b.p`
  ...
  white-space: nowrap;
  overflow: hidden;
`,Va=e=>!!e&&/^(https?:|data:|blob:|\/)/.test(e),Ga=()=>i.jsxs("svg",{viewBox:"0 0 24 24",fill:"currentColor",children:[i.jsx("rect",{x:"4.5",y:"2.5",width:"15",height:"17.5",rx:"3.4"}),i.jsx("rect",{x:"6.6",y:"4.6",width:"10.8",height:"2.4",rx:".7",fill:"#fff",fillOpacity:".5"}),i.jsx("rect",{x:"6.6",y:"8.6",width:"10.8",height:"5",rx:"1.3",fill:"#fff",fillOpacity:".92"}),i.jsx("circle",{cx:"7.4",cy:"17.4",r:"1.05",fill:"#fff",fillOpacity:".92"}),i.jsx("circle",{cx:"16.6",cy:"17.4",r:"1.05",fill:"#fff",fillOpacity:".92"})]}),Xa=()=>i.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:[i.jsx("rect",{x:"5",y:"3.5",width:"14",height:"17",rx:"1.5"}),i.jsx("path",{d:"M8.5 7h2M13.5 7h2M8.5 11h2M13.5 11h2M8.5 15h2M13.5 15h2M10 20.5v-3h4v3"})]}),Ua=({id:e,item:r,rows:t,onItemClick:n,isSubcontract:o})=>i.jsx(Ha,{title:r.title,clickable:typeof n=="function",rows:t,$isSubcontract:o,onClick:()=>n==null?void 0:n({id:e,label:r}),children:i.jsxs(za,{children:[i.jsx(Wa,{$provider:o,children:Va(r.icon)?i.jsx(ja,{src:r.icon,alt:""}):o?i.jsx(Xa,{}):i.jsx(Ga,{})}),i.jsxs(Za,{children:[i.jsx(Br,{isMain:!0,children:r.title}),i.jsx(Br,{children:r.subtitle})]})]})}),Ka=b.div`
  display: flex;
  align-items: center;
  gap: 5px;
...
`,An=({isLoading:e,position:r})=>e?i.jsx(ec,{position:r,children:i.jsx(nc,{})}):null,Ve=(e,r)=>{const{ctx:t,x:n,y:o,width:s,height:a,textYPos:l,label:d,font:c,isBottomRow:u,fillStyle:h,topText:v,bottomText:M,strokeStyle:x,labelBetweenCells:$}=e;if(t.beginPath(),t.strokeStyle=x??r.colors.border,t.setLineDash([]),d&&c&&l){t.fillStyle=r.colors.gridBackground,t.fillRect(n,o,s,a),$?(t.moveTo(n,o),t.lineTo(n+s,o),t.stroke(),t.moveTo(n,o+a),t.lineTo(n+s,o+a),t.stroke(),t.moveTo(n+s/2,o+a),t.lineTo(n+s/2,o+a-5),t.stroke()):t.strokeRect(n+.5,o+.5,s,a),t.font=c;const m=n+s/2-t.measureText(d).width/2;t.textBaseline="middle",t.fillStyle=r.colors.accent,t.fillText(d,m,l)}if(u&&h&&v&&M){t.fillStyle=h,t.fillRect(n,o,s,a),t.strokeRect(n+.5,o+.5,s,a),t.font=v.font;const m=n+s/2-t.measureText(v.label).width/2;t.fillStyle=v.color,t.fillText(v.label,m,v.y),t.font=M.font;const N=n+s/2-t.measureText(M.label).width/2;t.fillStyle=M.color,t.fillText(M.label,N,M.y)}},Pn=(e,r)=>{const{isCurrent:t,isBusinessDay:n,variant:o}=e;return t?o==="bottomRow"?r.colors.placeholder:r.colors.accent:n?o==="bottomRow"?r.colors.placeholder:r.colors.textPrimary:r.colors.placeholder},rc=(e,r,t,n)=>{const o=dt-Re/ms,s=dt-Re/gs,a=ze+lt;let l=0;for(let d=0;d<r;d++){const c=br(A(`${t.year}-${t.month+1}-${t.dayOfMonth}`).add(d,"days")),u=c.isCurrentDay;if(Ve({ctx:e,x:l,y:a,width:ke,height:Re,isBottomRow:!0,fillStyle:u?n.colors.currentDay:c.isBusinessDay?n.colors.gridBackground:n.colors.primary,topText:{y:o,label:u?"":c.dayName.toUpperCase(),font:Fe.bottomRow.name,color:Pn({isCurrent:!1,isBusinessDay:c.isBusinessDay},n)},bottomText:{y:s,label:`${c.dayOfMonth}`,font:u?`700 10px ${Ne}`:Fe.bottomRow.number,color:u?n.colors.today:Pn({isCurrent:!1,isBusinessDay:c.isBusinessDay,variant:"bottomRow"},n)}},n),u){const M=l+ke/2,x=o-13/2;e.save(),e.fillStyle=n.colors.today,e.beginPath(),e.roundRect?e.roundRect(M-30/2,x,30,13,5):e.rect(M-30/2,x,30,13),e.fill(),e.fillStyle="#fff",e.font=`800 8.5px ${Ne}`,e.textAlign="center",e.textBaseline="middle",e.fillText("HOY",M,x+13/2+.5),e.restore()}l+=ke}},oc=(e,r,t,n)=>{let o=-(t.dayOfMonth-1)*Ie;const s=ze;let l=t.month;for(let d=0;d<r;d++){l>=cn&&(l=0);const c=xr(t,d)*Ie;Ve({ctx:e,x:o,y:s,width:c,height:lt,textYPos:pr,label:A().month(l).format("MMMM").toUpperCase(),font:Fe.bottomRow.number},n),o+=c,l++}},sc=(e,r,t)=>{let o=0,s=0,a=A(`${r.year}-${r.month+1}-${r.dayOfMonth}`).month();o=-r.dayOfMonth*ke+ke;for(let l=0;l<cn;l++)a>cn-1&&(a=0),s=A(`${r.year}-${r.month+1}-${r.dayOfMonth}`).add(l,"months").daysInMonth()*ke,Ve({ctx:e,x:o,y:0,width:s,height:ze,textYPos:dn,label:A(`${r.year}-${r.month+1}-${r.dayOfMonth}`).month(a).format("MMMM YYYY").toUpperCase()+`                                                                                                  ${A(`${r.year}-${r.month+1}-${r.dayOfMonth}`).month(a).format("MMMM YYYY").toUpperCase()}`,font:Fe.topRow},t),o+=s,a++},ic=(e,r,t,n)=>{const o=7*ke,s=ze,a=e.canvas.width/o+o,l=r.weekOfYear;let d=0;for(let c=0;c<a;c++){const u=A(`${r.year}-${r.month+1}-${r.dayOfMonth}`).day();let h=(l+c)%ur;h<=0&&(h+=ur),u!==1&&c===0&&(d=-u*ke+ke),Ve({ctx:e,x:d,y:s,width:o,height:lt,textYPos:pr,label:`${t.toUpperCase()} ${h}`,font:Fe.middleRow},n),d+=o}},ac=(e,r)=>{const{isCurrent:t,isBusinessDay:n,variant:o}=e;return o==="yearView"?t?r.colors.tertiary:r.colors.gridBackground:t?r.colors.currentDay:n?r.colors.primary:r.colors.secondary},cc=(e,r,t,n,o)=>{const s=dt-Re/1.6,a=dt-Re/4.5,l=ze+lt;let d=0;for(let c=0;c<r;c++){const u=A(`${t.year}-${t.month+1}-${t.dayOfMonth}`).add(c,"weeks"),h=u.isSame(A(),"week");Ve({ctx:e,x:d,y:l,width:ut,height:Re,isBottomRow:!0,fillStyle:h?o.colors.today+"26":ac({isCurrent:h,variant:"yearView"},o),topText:{y:s,label:u.isoWeek().toString(),font:h?`700 14px ${Ne}`:Fe.bottomRow.name,color:h?o.colors.today:Pn({isCurrent:h},o)},bottomText:{y:a,label:n.toUpperCase(),font:Fe.middleRow,color:o.colors.placeholder}},o),d+=ut}},lc=(e,r,t,n)=>{const s=r.year,a=e.canvas.width*2;let l=0,d=0,c=(vr(s)-t+1)*Ie,u=0;for(;l+u<=a;)d>0&&(c=vr(s+d)*Ie),u+c>a&&d>0&&(c=Math.ceil((a-u)/Ie)*Ie),Ve({ctx:e,x:l,y:0,width:c,height:ze,textYPos:dn,label:(s+d).toString(),font:Fe.topRow},n),l+=c,u+=c,d++},dc=(e,r,t,n)=>{const o=Math.floor(r/Nt)+2,s=Nt*_e;let d=-A(`${t.year}-${t.month+1}-${t.dayOfMonth}T${t.hour}:00:00`).hour()*_e+.5*_e;for(let c=0;c<o;c++){const u=A(`${t.year}-${t.month+1}-${t.dayOfMonth}`).add(c,"day").format("dddd DD/MM/YYYY").toUpperCase();Ve({ctx:e,x:d,y:ft,width:s,height:Mt,textYPos:ft+Mt/2+2,label:u,font:Fe.bottomRow.number},n),d+=s}},uc=(e,r,t,n)=>{const o=Math.ceil(r/Nt),s=A(`${t.year}-${t.month+1}-${t.dayOfMonth}`),a=s.add(o-1,"days"),l=s.month(),d=a.add(1,"day").month(),c=l===d?1:2;let u=.5*_e;for(let h=0;h<c;h++){const v=A(`${t.year}-${t.month+1}-${t.dayOfMonth}T${t.hour}:00:00`),x=A(`${t.year}-${t.month+h+1}-01T:23:59:59`).endOf("month"),$=x.format("MMMM").toUpperCase(),m=x.diff(v,"hour")+1,N=h===0?m*_e:r*_e;Ve({ctx:e,x:u,y:0,width:N,height:ft,textYPos:dn,label:$,font:Fe.topRow},n),u+=N}},fc=(e,r,t,n)=>{let o=0;const s=ft+Mt,a=A(`${t.year}-${t.month+1}-${t.dayOfMonth}T${t.hour}:00:00`),l=_e;for(let d=0;d<r;d++){const c=a.add(d,"hours").format("h:00a").toUpperCase();Ve({ctx:e,x:o,y:s,width:l,height:an,label:c,font:Fe.bottomRow.hoursInDay,textYPos:ft+Mt+an/2+2,labelBetweenCells:!0},n),o+=_e}},hc=(e,r,t,n,o,s,a)=>{switch(r){case 0:lc(e,n,s,a),oc(e,t,n,a),cc(e,t,n,o,a);break;case 1:sc(e,n,a),ic(e,n,o,a),rc(e,t,n,a);break;case 2:uc(e,t,n,a),dc(e,t,n,a),fc(e,t,n,a);break}},pc=b.div`
  position: sticky;
  top: 0;
...
`,kc=[{label:"Sin chofer",stripe:"#9AA4B2",icon:"warn",color:"#9AA4B2"},{label:"Sin avisar",stripe:"#D98A22",icon:"warn",color:"#D98A22"},{label:"Notificado",stripe:"#2C6BB0",icon:"clock",color:"#2C6BB0"},{label:"Confirmado",stripe:"#2E8B63",icon:"check",color:"#2E8B63"}],$c=()=>i.jsxs(xc,{children:[i.jsx(zr,{children:"Leyenda"}),i.jsxs(Wt,{children:[i.jsx(Ge,{name:"transfer"})," Transfer"]}),i.jsxs(Wt,{children:[i.jsx(Ge,{name:"sun"})," Gira 1 día"]}),i.jsxs(Wt,{children:[i.jsx(Ge,{name:"tour"})," Gira multidía"]}),i.jsxs(Wt,{children:[i.jsx(bc,{children:"SUB"})," Subcontrato"]}),i.jsx(wc,{}),i.jsxs(zr,{children:["Estado ",i.jsx("em",{children:"franja izq. + punto esq."})]}),kc.map(e=>i.jsxs(Sc,{children:[i.jsx(Cc,{style:{background:e.stripe}}),i.jsx(Mc,{style:{color:e.color},children:i.jsx(Ge,{name:e.icon,strokeWidth:e.icon==="check"?2.6:2.2})}),e.label]},e.label))]}),Dc=p.forwardRef(function({zoom:r,topBarWidth:t,showThemeToggle:n,toggleTheme:o},s){const{week:a}=Ze(),{date:l,cols:d,dayOfYear:c,startDate:u,config:h}=je(),v=p.useRef(null),M=Lt(),x=p.useCallback($=>{const m=Sn(),X=(r===2?ps:dt)+1;kr($,m,X),hc($,r,d,u,a,c,M)},[d,c,u,a,r,M]);return p.useEffect(()=>{if(!v.current)return;const $=v.current.getContext("2d");if(!$)return;const m=()=>x($);return window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[x]),p.useEffect(()=>{const $=v.current;if(!$)return;$.style.letterSpacing="1px";const m=$.getContext("2d");m&&x(m)},[l,r,x]),i.jsxs(pc,{ref:s,children:[(h.showTopbar!==!1||h.showLegend!==!1)&&i.jsxs(mc,{$width:t,children:[h.showTopbar!==!1&&i.jsx(aa,{width:t,showThemeToggle:n,toggleTheme:o}),h.showLegend!==!1&&i.jsx($c,{})]}),i.jsx(gc,{id:ys,children:i.jsx(yc,{ref:v})})]})}),Ec=(e,r,t)=>{let n;switch(t){case 0:n=Ie;break;case 2:n=_e;break;default:n=ke}const s=e.startDate.startOf("day"),a=e.endDate.startOf("day"),l=r.startDate.startOf("day"),d=r.endDate.startOf("day"),c=()=>{let u;switch(t){case 2:u=(e.startDate.diff(r.startDate,"minute")/De+1)*n-n/2;break;default:u=s.diff(l,"day")*n}return Math.max(0,u)};if(e.startDate.isAfter(r.startDate)&&e.endDate.isBefore(r.endDate)){let u;switch(t){case 2:u=Math.max(e.endDate.diff(e.startDate,"minute")/De*n,50);break;default:u=Math.max(a.diff(s,"day")*n+n,50)}return{x:c(),width:u}}if(e.startDate.isBefore(r.startDate)&&e.endDate.isBefore(r.endDate)){let u;switch(t){case 2:u=Math.max(e.endDate.diff(r.startDate,"minute")/De*n+.5*n,50);break;default:u=Math.max(a.diff(l,"day")*n+n,50)}return{x:c(),width:u}}if(e.startDate.isAfter(r.startDate)&&e.endDate.isAfter(r.endDate)){let u;switch(t){case 2:u=Math.max(r.endDate.diff(e.startDate,"minute")/De*n,50);break;default:u=Math.max(d.diff(s,"day")*n+n,50)}return{x:c(),width:u}}if(e.startDate.isBefore(r.startDate)&&e.endDate.isAfter(r.endDate)){let u;switch(t){case 2:u=Math.max(r.endDate.diff(r.startDate,"minute")/De*n,50);break;default:u=Math.max(d.diff(l,"day")*n+n,50)}return{x:c(),width:u}}return{x:c(),width:50}},_c=(e,r,t,n,o,s)=>{const a=e*pe+vs,l=r.hour(),d=t.hour();let c,u,h,v;switch(s){case 2:{c=A(n),u=A(o),h=A(r).hour(l).minute(0),v=A(t).hour(d).minute(0);break}default:{c=A(n).hour(0).minute(0),u=A(o).hour(23).minute(59),h=r,v=t;break}}return{...Ec({startDate:c,endDate:u},{startDate:h,endDate:v},s),y:a}},Wr=e=>{if(!e)return"white";const r=[];for(let o=1;o<6;o+=2)r.push(parseInt(e.slice(o,o+2),16)/255);const t=r.map(o=>o<=.03928?o/12.92:Math.pow((o+.055)/1.055,2.4));return .2126*t[0]+.7152*t[1]+.0722*t[2]>.5?"black":"white"};b.div`
  margin: 10px 16px;
  position: relative;
  display: flex;
  font-size: 10px;
...
`,Pc=b.button`
  ...
  ${({$exiting:e})=>e&&st`
      ...
      pointer-events: none;
      @media (prefers-reduced-motion: no-preference) {
        animation: ${Ac} 190ms ease-out forwards;
      }
    `}
`,Oc=b.span`
  position: absolute;
...
`,zc=34,Wc={sin_chofer:{stripe:"#9AA4B2",icon:"warn",color:"#9AA4B2"},sin_avisar:{stripe:"#D98A22",icon:"warn",color:"#D98A22"},notificado:{stripe:"#2C6BB0",icon:"clock",color:"#2C6BB0"},confirmado:{stripe:"#2E8B63",icon:"check",color:"#2E8B63"}},jc="#3E8E5A",Zc="#D98A22",Ur=({row:e,data:r,zoom:t,isSubcontract:n=!1,onTileClick:o,onDragStart:s,isDragging:a=!1,isDraggable:l=!0,yOffset:d=0,exiting:c=!1})=>{const{date:u}=je(),h=Ht(u,t),{y:v,x:M,width:x}=_c(e,h.startDate,h.endDate,r.startDate,r.endDate,t),{colors:$}=Lt(),m=p.useRef(null),N=A(r.startDate).isSame(A(r.endDate),"day"),X=r.eventType===kt.Tour,F=r.eventType===kt.Transfer,P=N&&(X||F),f=Q=>{m.current={x:Q.clientX,y:Q.clientY},l&&s&&(Q.preventDefault(),s(r,Q))},y=Q=>{if(m.current){const I=Math.abs(Q.clientX-m.current.x),k=Math.abs(Q.clientY-m.current.y);Math.sqrt(I*I+k*k)<=5&&(o==null||o(r)),m.current=null}else o==null||o(r)},S={left:`${M}px`,top:`${v+d}px`,backgroundColor:`${r.bgColor??$.defaultTile}`,width:`${x}px`,color:Wr(r.bgColor??"")},_=!n&&r.readiness?Wc[r.readiness]:null,w=n&&r.subcontractConfirmed===!1,E=n?w?Zc:jc:_==null?void 0:_.stripe,W=Q=>i.jsxs(Pc,{"data-segment-id":r.segmentId,style:S,onClick:y,onMouseDown:f,onDragStart:I=>I.preventDefault(),isDraggable:l,isDragging:a,$unconfirmed:w,$exiting:c,children:[E&&i.jsx(Oc,{style:{background:E}}),Q]});return W(P?i.jsxs(i.Fragment,{children:[(n||_)&&i.jsx(Zr,{$sm:!0,children:n?i.jsx(Gr,{children:"SUB"}):_&&i.jsx(Vr,{$sm:!0,style:{color:_.color},children:i.jsx(Ge,{name:_.icon,strokeWidth:_.icon==="check"?2.6:2.2})})}),i.jsxs(Hc,{$transfer:F,children:[i.jsx(Ge,{name:F?"transfer":"sun",strokeWidth:2.4}),x>=zc&&i.jsxs(i.Fragment,{children:[i.jsx(Xr,{children:A(r.startDate).format("HH:mm")}),!F&&i.jsx(Xr,{$end:!0,children:A(r.endDate).format("HH:mm")})]})]})]}):i.jsxs(i.Fragment,{children:[i.jsx(Zr,{children:n?i.jsx(Gr,{children:"SUB"}):_&&i.jsx(Vr,{style:{color:_.color},children:i.jsx(Ge,{name:_.icon,strokeWidth:_.icon==="check"?2.6:2.2})})}),r.bookingNumber&&i.jsx(Fc,{children:r.bookingNumber}),i.jsxs(Ic,{children:[i.jsxs(jr,{$pad:!0,children:[i.jsx(Yc,{children:i.jsx(Ge,{name:F?"transfer":"tour"})}),i.jsx(Lc,{children:r.title})]}),r.subtitle&&i.jsx(jr,{children:i.jsx(Nc,{children:r.subtitle})}),r.driver&&i.jsxs(Bc,{children:[i.jsx(Ge,{name:"person"}),r.driver]})]})]}))},Kr=(e,r)=>{let t=0;for(const n of r)e>=n&&t++;return t*Oe},Vc=He`
  from { opacity: 0; }
  to { opacity: 1; }
`,Gc=b.div`
  position: absolute;
...
`,Et=b.div`
  ...
  max-height: 60px;
  overflow-y: auto;
`;b.div``,b.span``,b.span``,b.div``,b.div``,b.span``,b.span``,b.div``,b.div``,b.span``,b.span``,b.div``,b.div``,b.div``,b.span``,b.div``,b.div``,b.div``,b.div``,b.p``,b.span``;const al={client:"Client",startDate:"Start",endDate:"End",groupName:"Group",driver:"Driver",flightNumber:"Flight",serviceNotes:"Service Notes",reservationNotes:"Reservation Notes",salida:"Salida",destino:"Destino",regreso:"Regreso",tour:"Tour",transfer:"Transfer",oneDay:"One-day",passengers:"Pax"},cl=({tooltipData:e,visible:r=!0})=>{const{mouseCoords:t,reservationData:n}=e,o=p.useRef(null),[s,a]=p.useState("below"),l=Ze(),d={...al,...l.tooltip};p.useLayoutEffect(()=>{if(!o.current||!t)return;const x=o.current,{width:$,height:m}=x.getBoundingClientRect(),N=x.parentElement;if(!N)return;const X=N.getBoundingClientRect(),F=12,P=4,f=X.height-t.y,y=X.width-t.x;let S=t.x+F,_=t.y+F,w="below";y<$+F&&(S=t.x-$-F),f<m+F&&(_=t.y-m-F,w="above"),S=Math.max(P,Math.min(S,X.width-$-P)),_=Math.max(P,Math.min(_,X.height-m-P)),a(w),x.style.left=`${S}px`,x.style.top=`${_}px`},[t]);const c=n.reservationType===kt.Tour,u=c&&n.isOneDayEvent,h=()=>c?u?"oneday":"tour":"transfer",v=()=>c?u?d.oneDay:d.tour:d.transfer,M=[n.groupName&&{label:d.groupName,value:n.groupName},n.driver&&{label:d.driver,value:n.driver},n.passengers&&{label:d.passengers,value:String(n.passengers)},n.flightNumber&&{label:d.flightNumber,value:n.flightNumber}].filter(Boolean);return i.jsxs(Uc,{ref:o,$position:s,$visible:r,children:[i.jsxs(Kc,{children:[i.jsxs(qc,{children:[i.jsx(Jc,{children:n.bookingNumber}),i.jsx(Qc,{$type:h(),children:v()})]}),i.jsx(Rc,{children:n.eventName}),n.client&&i.jsx(el,{children:n.client})]}),i.jsxs(tl,{children:[i.jsxs(nl,{children:[i.jsxs(qr,{children:[i.jsx(Jr,{children:d.startDate}),i.jsxs(Qr,{children:[i.jsx(Rr,{children:n.startDate})," ",i.jsx(eo,{children:n.startTime})]})]}),c&&n.endDate&&i.jsxs(qr,{$isEnd:!0,children:[i.jsx(Jr,{children:d.endDate}),i.jsxs(Qr,{children:[i.jsx(Rr,{children:n.endDate})," ",i.jsx(eo,{children:n.endTime})]})]})]}),M.length>0&&i.jsx(rl,{children:M.map((x,$)=>i.jsxs(ol,{children:[i.jsx(sl,{children:x.label}),i.jsx(il,{children:x.value})]},$))}),(n.departureAddress||n.destinationAddress||n.returnAddress)&&i.jsxs(to,{children:[n.departureAddress&&i.jsxs($t,{children:[i.jsx(Dt,{children:d.salida}),i.jsx(Et,{children:n.departureAddress})]}),n.destinationAddress&&i.jsxs($t,{children:[i.jsx(Dt,{children:d.destino}),i.jsx(Et,{children:n.destinationAddress})]}),n.returnAddress&&i.jsxs($t,{children:[i.jsx(Dt,{children:d.regreso}),i.jsx(Et,{children:n.returnAddress})]})]}),(n.serviceNotes||n.reservationNotes)&&i.jsxs(to,{children:[n.serviceNotes&&i.jsxs($t,{children:[i.jsx(Dt,{children:d.serviceNotes}),i.jsx(Et,{children:n.serviceNotes})]}),n.reservationNotes&&i.jsxs($t,{children:[i.jsx(Dt,{children:d.reservationNotes}),i.jsx(Et,{children:n.reservationNotes})]})]})]})]})};b.div`
  display: flex;
  align-items: center;
  cursor: pointer;
  width: 60px;
...
`,Sl=({selectionBox:e,isSelecting:r})=>!e||!r?null:i.jsx(wl,{style:{left:e.x,top:e.y,width:e.width,height:e.height}}),Cl=He`
  from {
    opacity: 0;
...
`,Fl=({zoom:e,startDate:r})=>{const{cols:t}=je(),n=p.useMemo(()=>{if(e===2)return null;const o=e===0?Ie*7:ke,s=A().year(r.year).month(r.month).date(r.dayOfMonth).startOf("day"),a=A().startOf("day"),l=e===0?a.startOf("week").diff(s.startOf("week"),"week"):a.diff(s,"days");return l<0||l>=t?null:{x:l*o,width:o}},[e,r,t]);return n?i.jsx(Nl,{style:{left:`${n.x}px`,width:`${n.width}px`},"aria-hidden":!0}):null},gd="";Ae.Scheduler=Da,Object.defineProperty(Ae,Symbol.toStringTag,{value:"Module"})});
