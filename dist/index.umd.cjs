 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tn;function io(){return Tn||(Tn=1,process.env.NODE_ENV!=="production"&&function(){var e=Symbol.for("react.element"),n=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),s=Symbol.for("react.provider"),i=Symbol.for("react.context"),l=Symbol.for("react.server_context"),u=Symbol.for("react.forward_ref"),c=Symbol.for("react.suspense"),d=Symbol.for("react.suspense_list"),h=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),S=Symbol.for("react.offscreen"),x=!1,k=!1,g=!1,F=!1,G=!1,j;j=Symbol.for("react.module.reference");function E(N){return!!(typeof N=="string"||typeof N=="function"||N===t||N===o||G||N===r||N===c||N===d||F||N===S||x||k||g||typeof N=="object"&&N!==null&&(N.$$typeof===y||N.$$typeof===h||N.$$typeof===s||N.$$typeof===i||N.$$typeof===u||N.$$typeof===j||N.getModuleId!==void 0))}function f(N){if(typeof N=="object"&&N!==null){var q=N.$$typeof;switch(q){case e:var se=N.type;switch(se){case t:case o:case r:case c:case d:return se;default:var U=se&&se.$$typeof;switch(U){case l:case i:case u:case y:case h:case s:return U;default:return q}}case n:return q}}}var m=i,b=s,_=e,P=u,W=t,Z=y,R=h,$=n,A=o,T=r,B=c,Y=d,J=!1,ee=!1;function ie(N){return J||(J=!0,console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 18+.")),!1}function oe(N){return ee||(ee=!0,console.warn("The ReactIs.isConcurrentMode() alias has been deprecated, and will be removed in React 18+.")),!1}function z(N){return f(N)===i}function V(N){return f(N)===s}function K(N){return typeof N=="object"&&N!==null&&N.$$typeof===e}function X(N){return f(N)===u}function C(N){return f(N)===t}function O(N){return f(N)===y}function v(N){return f(N)===h}function L(N){return f(N)===n}function H(N){return f(N)===o}function I(N){return f(N)===r}function M(N){return f(N)===c}function te(N){return f(N)===d}he.ContextConsumer=m,he.ContextProvider=b,he.Element=_,he.ForwardRef=P,he.Fragment=W,he.Lazy=Z,he.Memo=R,he.Portal=$,he.Profiler=A,he.StrictMode=T,he.Suspense=B,he.SuspenseList=Y,he.isAsyncMode=ie,he.isConcurrentMode=oe,he.isContextConsumer=z,he.isContextProvider=V,he.isElement=K,he.isForwardRef=X,he.isFragment=C,he.isLazy=O,he.isMemo=v,he.isPortal=L,he.isProfiler=H,he.isStrictMode=I,he.isSuspense=M,he.isSuspenseList=te,he.isValidElementType=E,he.typeOf=f}()),he}(function(e){process.env.NODE_ENV==="production"?e.exports=so():e.exports=io()})(oo);function ao(e){function n(z,V,K,X,C){for(var O=0,v=0,L=0,H=0,I,M,te=0,N=0,q,se=q=I=0,U=0,le=0,ne=0,ce=0,me=K.length,Me=me-1,ve,Q="",ae="",de="",xe="",be;U<me;){if(M=K.charCodeAt(U),U===Me&&v+H+L+O!==0&&(v!==0&&(M=v===47?10:47),H=L=O=0,me++,Me++),v+H+L+O===0){if(U===Me&&(0<le&&(Q=Q.replace(y,"")),0<Q.trim().length)){switch(M){case 32:case 9:case 59:case 13:case 10:break;default:Q+=K.charAt(U)}M=59}switch(M){case 123:for(Q=Q.trim(),I=Q.charCodeAt(0),q=1,ce=++U;U<me;){switch(M=K.charCodeAt(U)){case 123:q++;break;case 125:q--;break;case 47:switch(M=K.charCodeAt(U+1)){case 42:case 47:e:{for(se=U+1;se<Me;++se)switch(K.charCodeAt(se)){case 47:if(M===42&&K.charCodeAt(se-1)===42&&U+2!==se){U=se+1;break e}break;case 10:if(M===47){U=se+1;break e}}U=se}}break;case 91:M++;case 40:M++;case 34:case 39:for(;U++<Me&&K.charCodeAt(U)!==M;);}if(q===0)break;U++}switch(q=K.substring(ce,U),I===0&&(I=(Q=Q.replace(h,"").trim()).charCodeAt(0)),I){case 64:switch(0<le&&(Q=Q.replace(y,"")),M=Q.charCodeAt(1),M){case 100:case 109:case 115:case 45:le=V;break;default:le=B}if(q=n(V,le,q,M,C+1),ce=q.length,0<J&&(le=t(B,Q,ne),be=l(3,q,le,V,$,R,ce,M,C,X),Q=le.join(""),be!==void 0&&(ce=(q=be.trim()).length)===0&&(M=0,q="")),0<ce)switch(M){case 115:Q=Q.replace(m,i);case 100:case 109:case 45:q=Q+"{"+q+"}";break;case 107:Q=Q.replace(G,"$1 $2"),q=Q+"{"+q+"}",q=T===1||T===2&&s("@"+q,3)?"@-webkit-"+q+"@"+q:"@"+q;break;default:q=Q+q,X===112&&(q=(ae+=q,""))}else q="";break;default:q=n(V,t(V,Q,ne),q,X,C+1)}de+=q,q=ne=le=se=I=0,Q="",M=K.charCodeAt(++U);break;case 125:case 59:if(Q=(0<le?Q.replace(y,""):Q).trim(),1<(ce=Q.length))switch(se===0&&(I=Q.charCodeAt(0),I===45||96<I&&123>I)&&(ce=(Q=Q.replace(" ",":")).length),0<J&&(be=l(1,Q,V,z,$,R,ae.length,X,C,X))!==void 0&&(ce=(Q=be.trim()).length)===0&&(Q="\0\0"),I=Q.charCodeAt(0),M=Q.charCodeAt(1),I){case 0:break;case 64:if(M===105||M===99){xe+=Q+K.charAt(U);break}default:Q.charCodeAt(ce-1)!==58&&(ae+=o(Q,I,M,Q.charCodeAt(2)))}ne=le=se=I=0,Q="",M=K.charCodeAt(++U)}}switch(M){case 13:case 10:v===47?v=0:1+I===0&&X!==107&&0<Q.length&&(le=1,Q+="\0"),0<J*ie&&l(0,Q,V,z,$,R,ae.length,X,C,X),R=1,$++;break;case 59:case 125:if(v+H+L+O===0){R++;break}default:switch(R++,ve=K.charAt(U),M){case 9:case 32:if(H+O+v===0)switch(te){case 44:case 58:case 9:case 32:ve="";break;default:M!==32&&(ve=" ")}break;case 0:ve="\\0";break;case 12:ve="\\f";break;case 11:ve="\\v";break;case 38:H+v+O===0&&(le=ne=1,ve="\f"+ve);break;case 108:if(H+v+O+A===0&&0<se)switch(U-se){case 2:te===112&&K.charCodeAt(U-3)===58&&(A=te);case 8:N===111&&(A=N)}break;case 58:H+v+O===0&&(se=U);break;case 44:v+L+H+O===0&&(le=1,ve+="\r");break;case 34:case 39:v===0&&(H=H===M?0:H===0?M:H);break;case 91:H+v+L===0&&O++;break;case 93:H+v+L===0&&O--;break;case 41:H+v+O===0&&L--;break;case 40:if(H+v+O===0){if(I===0)switch(2*te+3*N){case 533:break;default:I=1}L++}break;case 64:v+L+H+O+se+q===0&&(q=1);break;case 42:case 47:if(!(0<H+O+L))switch(v){case 0:switch(2*M+3*K.charCodeAt(U+1)){case 235:v=47;break;case 220:ce=U,v=42}break;case 42:M===47&&te===42&&ce+2!==U&&(K.charCodeAt(ce+2)===33&&(ae+=K.substring(ce,U+1)),ve="",v=0)}}v===0&&(Q+=ve)}N=te,te=M,U++}if(ce=ae.length,0<ce){if(le=V,0<J&&(be=l(2,ae,le,z,$,R,ce,X,C,X),be!==void 0&&(ae=be).length===0))return xe+ae+de;if(ae=le.join(",")+"{"+ae+"}",T*A!==0){switch(T!==2||s(ae,2)||(A=0),A){case 111:ae=ae.replace(E,":-moz-$1")+ae;break;case 112:ae=ae.replace(j,"::-webkit-input-$1")+ae.replace(j,"::-moz-$1")+ae.replace(j,":-ms-input-$1")+ae}A=0}}return xe+ae+de}function t(z,V,K){var X=V.trim().split(g);V=X;var C=X.length,O=z.length;switch(O){case 0:case 1:var v=0;for(z=O===0?"":z[0]+" ";v<C;++v)V[v]=r(z,V[v],K).trim();break;default:var L=v=0;for(V=[];v<C;++v)for(var H=0;H<O;++H)V[L++]=r(z[H]+" ",X[v],K).trim()}return V}function r(z,V,K){var X=V.charCodeAt(0);switch(33>X&&(X=(V=V.trim()).charCodeAt(0)),X){case 38:return V.replace(F,"$1"+z.trim());case 58:return z.trim()+V.replace(F,"$1"+z.trim());default:if(0<1*K&&0<V.indexOf("\f"))return V.replace(F,(z.charCodeAt(0)===58?"":"$1")+z.trim())}return z+V}function o(z,V,K,X){var C=z+";",O=2*V+3*K+4*X;if(O===944){z=C.indexOf(":",9)+1;var v=C.substring(z,C.length-1).trim();return v=C.substring(0,z).trim()+v+";",T===1||T===2&&s(v,1)?"-webkit-"+v+v:v}if(T===0||T===2&&!s(C,1))return C;switch(O){case 1015:return C.charCodeAt(10)===97?"-webkit-"+C+C:C;case 951:return C.charCodeAt(3)===116?"-webkit-"+C+C:C;case 963:return C.charCodeAt(5)===110?"-webkit-"+C+C:C;case 1009:if(C.charCodeAt(4)!==100)break;case 969:case 942:return"-webkit-"+C+C;case 978:return"-webkit-"+C+"-moz-"+C+C;case 1019:case 983:return"-webkit-"+C+"-moz-"+C+"-ms-"+C+C;case 883:if(C.charCodeAt(8)===45)return"-webkit-"+C+C;if(0<C.indexOf("image-set(",11))return C.replace(Z,"$1-webkit-$2")+C;break;case 932:if(C.charCodeAt(4)===45)switch(C.charCodeAt(5)){case 103:return"-webkit-box-"+C.replace("-grow","")+"-webkit-"+C+"-ms-"+C.replace("grow","positive")+C;case 115:return"-webkit-"+C+"-ms-"+C.replace("shrink","negative")+C;case 98:return"-webkit-"+C+"-ms-"+C.replace("basis","preferred-size")+C}return"-webkit-"+C+"-ms-"+C+C;case 964:return"-webkit-"+C+"-ms-flex-"+C+C;case 1023:if(C.charCodeAt(8)!==99)break;return v=C.substring(C.indexOf(":",15)).replace("flex-","").replace("space-between","justify"),"-webkit-box-pack"+v+"-webkit-"+C+"-ms-flex-pack"+v+C;case 1005:return x.test(C)?C.replace(S,":-webkit-")+C.replace(S,":-moz-")+C:C;case 1e3:switch(v=C.substring(13).trim(),V=v.indexOf("-")+1,v.charCodeAt(0)+v.charCodeAt(V)){case 226:v=C.replace(f,"tb");break;case 232:v=C.replace(f,"tb-rl");break;case 220:v=C.replace(f,"lr");break;default:return C}return"-webkit-"+C+"-ms-"+v+C;case 1017:if(C.indexOf("sticky",9)===-1)break;case 975:switch(V=(C=z).length-10,v=(C.charCodeAt(V)===33?C.substring(0,V):C).substring(z.indexOf(":",7)+1).trim(),O=v.charCodeAt(0)+(v.charCodeAt(7)|0)){case 203:if(111>v.charCodeAt(8))break;case 115:C=C.replace(v,"-webkit-"+v)+";"+C;break;case 207:case 102:C=C.replace(v,"-webkit-"+(102<O?"inline-":"")+"box")+";"+C.replace(v,"-webkit-"+v)+";"+C.replace(v,"-ms-"+v+"box")+";"+C}return C+";";case 938:if(C.charCodeAt(5)===45)switch(C.charCodeAt(6)){case 105:return v=C.replace("-items",""),"-webkit-"+C+"-webkit-box-"+v+"-ms-flex-"+v+C;case 115:return"-webkit-"+C+"-ms-flex-item-"+C.replace(_,"")+C;default:return"-webkit-"+C+"-ms-flex-line-pack"+C.replace("align-content","").replace(_,"")+C}break;case 973:case 989:if(C.charCodeAt(3)!==45||C.charCodeAt(4)===122)break;case 931:case 953:if(W.test(z)===!0)return(v=z.substring(z.indexOf(":")+1)).charCodeAt(0)===115?o(z.replace("stretch","fill-available"),V,K,X).replace(":fill-available",":stretch"):C.replace(v,"-webkit-"+v)+C.replace(v,"-moz-"+v.replace("fill-",""))+C;break;case 962:if(C="-webkit-"+C+(C.charCodeAt(5)===102?"-ms-"+C:"")+C,K+X===211&&C.charCodeAt(13)===105&&0<C.indexOf("transform",10))return C.substring(0,C.indexOf(";",27)+1).replace(k,"$1-webkit-$2")+C}return C}function s(z,V){var K=z.indexOf(V===1?":":"{"),X=z.substring(0,V!==3?K:10);return K=z.substring(K+1,z.length-1),ee(V!==2?X:X.replace(P,"$1"),K,V)}function i(z,V){var K=o(V,V.charCodeAt(0),V.charCodeAt(1),V.charCodeAt(2));return K!==V+";"?K.replace(b," or ($1)").substring(4):"("+V+")"}function l(z,V,K,X,C,O,v,L,H,I){for(var M=0,te=V,N;M<J;++M)switch(N=Y[M].call(d,z,te,K,X,C,O,v,L,H,I)){case void 0:case!1:case!0:case null:break;default:te=N}if(te!==V)return te}function u(z){switch(z){case void 0:case null:J=Y.length=0;break;default:if(typeof z=="function")Y[J++]=z;else if(typeof z=="object")for(var V=0,K=z.length;V<K;++V)u(z[V]);else ie=!!z|0}return u}function c(z){return z=z.prefix,z!==void 0&&(ee=null,z?typeof z!="function"?T=1:(T=2,ee=z):T=0),c}function d(z,V){var K=z;if(33>K.charCodeAt(0)&&(K=K.trim()),oe=K,K=[oe],0<J){var X=l(-1,V,K,K,$,R,0,0,0,0);X!==void 0&&typeof X=="string"&&(V=X)}var C=n(B,K,V,0,0);return 0<J&&(X=l(-2,C,K,K,$,R,C.length,0,0,0),X!==void 0&&(C=X)),oe="",A=0,R=$=1,C}var h=/^\0+/g,y=/[\0\r\f]/g,S=/: */g,x=/zoo|gra/,k=/([,: ])(transform)/g,g=/,\r+?/g,F=/([\t\r\n ])*\f?&/g,G=/@(k\w+)\s*(\S*)\s*/,j=/::(place)/g,E=/:(read-only)/g,f=/[svh]\w+-[tblr]{2}/,m=/\(\s*(.*)\s*\)/g,b=/([\s\S]*?);/g,_=/-self|flex-/g,P=/[^]*?(:[rp][el]a[\w-]+)[^]*/,W=/stretch|:\s*\w+\-(?:conte|avail)/,Z=/([^-])(image-set\()/,R=1,$=1,A=0,T=1,B=[],Y=[],J=0,ee=null,ie=0,oe="";return d.use=u,d.set=c,e!==void 0&&c(e),d}var co={animationIterationCount:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1};function lo(e){var n=Object.create(null);return function(t){return n[t]===void 0&&(n[t]=e(t)),n[t]}}var uo=/^((children|dangerouslySetInnerHTML|key|ref|autoFocus|defaultValue|defaultChecked|innerHTML|suppressContentEditableWarning|suppressHydrationWarning|valueLink|abbr|accept|acceptCharset|accessKey|action|allow|allowUserMedia|allowPaymentRequest|allowFullScreen|allowTransparency|alt|async|autoComplete|autoPlay|capture|cellPadding|cellSpacing|challenge|charSet|checked|cite|classID|className|cols|colSpan|content|contentEditable|contextMenu|controls|controlsList|coords|crossOrigin|data|dateTime|decoding|default|defer|dir|disabled|disablePictureInPicture|download|draggable|encType|enterKeyHint|form|formAction|formEncType|formMethod|formNoValidate|formTarget|frameBorder|headers|height|hidden|high|href|hrefLang|htmlFor|httpEquiv|id|inputMode|integrity|is|keyParams|keyType|kind|label|lang|list|loading|loop|low|marginHeight|marginWidth|max|maxLength|media|mediaGroup|method|min|minLength|multiple|muted|name|nonce|noValidate|open|optimum|pattern|placeholder|playsInline|poster|preload|profile|radioGroup|readOnly|referrerPolicy|rel|required|reversed|role|rows|rowSpan|sandbox|scope|scoped|scrolling|seamless|selected|shape|size|sizes|slot|span|spellCheck|src|srcDoc|srcLang|srcSet|start|step|style|summary|tabIndex|target|title|translate|type|useMap|value|width|wmode|wrap|about|datatype|inlist|prefix|property|resource|typeof|vocab|autoCapitalize|autoCorrect|autoSave|color|incremental|fallback|inert|itemProp|itemScope|itemType|itemID|itemRef|on|option|results|security|unselectable|accentHeight|accumulate|additive|alignmentBaseline|allowReorder|alphabetic|amplitude|arabicForm|ascent|attributeName|attributeType|autoReverse|azimuth|baseFrequency|baselineShift|baseProfile|bbox|begin|bias|by|calcMode|capHeight|clip|clipPathUnits|clipPath|clipRule|colorInterpolation|colorInterpolationFilters|colorProfile|colorRendering|contentScriptType|contentStyleType|cursor|cx|cy|d|decelerate|descent|diffuseConstant|direction|display|divisor|dominantBaseline|dur|dx|dy|edgeMode|elevation|enableBackground|end|exponent|externalResourcesRequired|fill|fillOpacity|fillRule|filter|filterRes|filterUnits|floodColor|floodOpacity|focusable|fontFamily|fontSize|fontSizeAdjust|fontStretch|fontStyle|fontVariant|fontWeight|format|from|fr|fx|fy|g1|g2|glyphName|glyphOrientationHorizontal|glyphOrientationVertical|glyphRef|gradientTransform|gradientUnits|hanging|horizAdvX|horizOriginX|ideographic|imageRendering|in|in2|intercept|k|k1|k2|k3|k4|kernelMatrix|kernelUnitLength|kerning|keyPoints|keySplines|keyTimes|lengthAdjust|letterSpacing|lightingColor|limitingConeAngle|local|markerEnd|markerMid|markerStart|markerHeight|markerUnits|markerWidth|mask|maskContentUnits|maskUnits|mathematical|mode|numOctaves|offset|opacity|operator|order|orient|orientation|origin|overflow|overlinePosition|overlineThickness|panose1|paintOrder|pathLength|patternContentUnits|patternTransform|patternUnits|pointerEvents|points|pointsAtX|pointsAtY|pointsAtZ|preserveAlpha|preserveAspectRatio|primitiveUnits|r|radius|refX|refY|renderingIntent|repeatCount|repeatDur|requiredExtensions|requiredFeatures|restart|result|rotate|rx|ry|scale|seed|shapeRendering|slope|spacing|specularConstant|specularExponent|speed|spreadMethod|startOffset|stdDeviation|stemh|stemv|stitchTiles|stopColor|stopOpacity|strikethroughPosition|strikethroughThickness|string|stroke|strokeDasharray|strokeDashoffset|strokeLinecap|strokeLinejoin|strokeMiterlimit|strokeOpacity|strokeWidth|surfaceScale|systemLanguage|tableValues|targetX|targetY|textAnchor|textDecoration|textRendering|textLength|to|transform|u1|u2|underlinePosition|underlineThickness|unicode|unicodeBidi|unicodeRange|unitsPerEm|vAlphabetic|vHanging|vIdeographic|vMathematical|values|vectorEffect|version|vertAdvY|vertOriginX|vertOriginY|viewBox|viewTarget|visibility|widths|wordSpacing|writingMode|x|xHeight|x1|x2|xChannelSelector|xlinkActuate|xlinkArcrole|xlinkHref|xlinkRole|xlinkShow|xlinkTitle|xlinkType|xmlBase|xmlns|xmlnsXlink|xmlLang|xmlSpace|y|y1|y2|yChannelSelector|z|zoomAndPan|for|class|autofocus)|(([Dd][Aa][Tt][Aa]|[Aa][Rr][Ii][Aa]|x)-.*))$/,An=lo(function(e){return uo.test(e)||e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)<91}),Lt={},fo={get exports(){return Lt},set exports(e){Lt=e}},pe={};/** @license React v16.13.1
 * react-is.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
...
`,Ni=w.div`
  ...
  align-items: center;
`,wn={coords:{x:0,y:0},mouseCoords:{x:0,y:0},resourceIndex:0,disposition:{taken:{hours:0,minutes:0},free:{hours:0,minutes:0},overtime:{hours:0,minutes:0}},reservationData:{startTime:"",startDate:"",client:"",eventName:"",reservationType:yt.Tour,bookingNumber:""},tileBounds:{x:0,y:0,width:0,height:0}};function Fi(e,n){const t=n?[...n].sort((l,u)=>l.maxPassengers-u.maxPassengers):[],r=[];for(const l of t){const u=e.filter(c=>!c.isSubcontract&&c.categoryId===l.id);u.length>0&&r.push({type:"category",category:l,items:u})}const o=t.length>0,s=e.filter(l=>!l.isSubcontract&&(!l.categoryId||!o));s.length>0&&o?r.push({type:"uncategorized",items:s}):s.length>0&&r.push({type:"uncategorized",items:s});const i=e.filter(l=>l.isSubcontract);return i.length>0&&r.push({type:"subcontract",items:i}),r}const Hi=({data:e,baseData:n,categories:t,onTileClick:r,onItemClick:o,toggleTheme:s,topBarWidth:i,onEventDrop:l,onEventDrag:u,draggableConfig:c,onTimeRangeSelect:d,onMultiTimeRangeSelect:h,clickToAddConfig:y})=>{const[S,x]=p.useState(wn),[k,g]=p.useState(e),[F,G]=p.useState(!1),[j,E]=p.useState(!1),[f,m]=p.useState(""),[b,_]=p.useState(new Set),{zoom:P,startDate:W,isLoading:Z,config:{includeTakenHoursOnWeekendsInDayView:R,showTooltip:$,showThemeToggle:A}}=Le(),T=p.useRef(null),B=p.useRef(null),[Y,J]=p.useState(124),{page:ee,projectsPerPerson:ie,rowsPerItem:oe,currentPageNum:z,pagesAmount:V,next:K,previous:X,reset:C}=vi(k),{effectiveCategories:O,effectivePage:v}=p.useMemo(()=>{if(t&&t.length>0)return{effectiveCategories:t,effectivePage:ee};const Q=ci(ee);if(Q.categories.length===0)return{effectiveCategories:void 0,effectivePage:ee};const ae=ee.map(de=>{if(de.isSubcontract||de.capacity==null)return de;const xe=Q.capacityToCategoryId.get(de.capacity);return xe?{...de,categoryId:xe}:de});return{effectiveCategories:Q.categories,effectivePage:ae}},[t,ee]),L=p.useCallback(Q=>{_(ae=>{const de=new Set(ae);return de.has(Q)?de.delete(Q):de.add(Q),de})},[]),H=p.useMemo(()=>{const Q=[],ae=O?[...O].sort((de,xe)=>de.maxPassengers-xe.maxPassengers):[];for(const de of ae)v.some(xe=>!xe.isSubcontract&&xe.categoryId===de.id)&&Q.push(de.id);return v.some(de=>de.isSubcontract)&&Q.push("__subcontract__"),Q},[O,v]),I=p.useCallback(()=>{_(new Set)},[]),M=p.useCallback(()=>{_(new Set(H))},[H]),{visiblePage:te,visibleRowsPerItem:N,visibleTotalRows:q,visibleProjectsPerPerson:se,separatorRowIndices:U}=p.useMemo(()=>{const Q=Fi(v,O),ae=((O==null?void 0:O.length)??0)>0,de=new Map;ee.forEach((ke,Be)=>de.set(ke.id,Be));const xe=[],be=[],We=[],ze=[];let dt=0;for(const ke of Q)if(ke.type==="subcontract"||ke.type==="category"&&ae){const ut=ke.type==="subcontract"?"__subcontract__":ke.category.id,ft=b.has(ut);if(ze.push(dt),!ft)for(const Ke of ke.items){const Yt=de.get(Ke.id)??0,It=oe[Yt];xe.push(Ke),be.push(It),We.push(ie[Yt]),dt+=It}}else for(const ut of ke.items){const ft=de.get(ut.id)??0,Ke=oe[ft];xe.push(ut),be.push(Ke),We.push(ie[ft]),dt+=Ke}const En=be.reduce((ke,Be)=>ke+Be,0);return{visiblePage:xe,visibleRowsPerItem:be,visibleTotalRows:En,visibleProjectsPerPerson:We,separatorRowIndices:ze}},[v,O,ee,b,oe,ie]),le=p.useRef(it((Q,ae,de,xe,be,We)=>{if(!T.current)return;const{tile:ze,segmentId:dt}=me(Q);if(!dt||!ze){G(!1),x(wn);return}const En=ce(dt,ae),ke=T.current.getBoundingClientRect(),Be=ze.getBoundingClientRect(),ut={x:Q.clientX-ke.left,y:Q.clientY-ke.top},ft={x:Q.clientX-ke.left,y:Q.clientY-ke.top},Ke={x:Be.left-ke.left,y:Be.top-ke.top,width:Be.width,height:Be.height},{coords:{x:Yt,y:It},resourceIndex:Sl,disposition:Cl,reservationData:Ml}=ii(En,de,ut,xe,be,We,R);x({coords:{x:Yt,y:It},mouseCoords:ft,resourceIndex:Sl,disposition:Cl,reservationData:Ml,tileBounds:Ke}),G(!0)},4)),ne=p.useRef(it((Q,ae)=>{C(),g(Q.map(de=>({...de,data:de.data.filter(xe=>{const{title:be,description:We,subtitle:ze}=xe;return(be==null?void 0:be.toLowerCase().includes(ae.toLowerCase()))||(ze==null?void 0:ze.toLowerCase().includes(ae.toLowerCase()))||(We==null?void 0:We.toLowerCase().includes(ae.toLowerCase()))})})).filter(de=>de.data.length>0))},500)),ce=(Q,ae)=>{if(Q)return ae.flatMap(de=>de.data).find(de=>de.segmentId===Q)},me=Q=>{if(!Q.target)return{tile:null,segmentId:null};const ae=Q.target.closest("[data-segment-id]");return ae?{tile:ae,segmentId:ae.getAttribute("data-segment-id")}:{tile:null,segmentId:null}},Me=Q=>{const ae=Q.target.value;m(ae),ne.current.cancel(),ae?ne.current(e,ae):(C(),g(e))},ve=p.useCallback(()=>{le.current.cancel(),G(!1),x(wn)},[]);return p.useEffect(()=>{const Q=de=>le.current(de,e,W,N,se,P),ae=T.current;if(ae)return ae.addEventListener("mousemove",Q),ae.addEventListener("mouseleave",ve),()=>{ae.removeEventListener("mousemove",Q),ae.removeEventListener("mouseleave",ve)}},[le,ve,se,N,W,P,e]),p.useEffect(()=>{f?(ne.current.cancel(),ne.current(e,f)):g(e)},[e,f]),p.useLayoutEffect(()=>{const Q=B.current;if(!Q)return;const ae=()=>J(Q.offsetHeight);ae();const de=new ResizeObserver(ae);return de.observe(Q),()=>de.disconnect()},[]),a.jsxs(Ii,{children:[a.jsx(Na,{headerHeight:Y,data:v,categories:O,pageNum:z,pagesAmount:V,rows:oe,onLoadNext:K,onLoadPrevious:X,searchInputValue:f,onSearchInputChange:Me,onItemClick:o,collapsedGroups:b,onToggleGroup:L,allGroupIds:H,onExpandAll:I,onCollapseAll:M}),a.jsxs(Li,{children:[a.jsx(uc,{ref:B,zoom:P,topBarWidth:i,showThemeToggle:A,toggleTheme:s}),e.length?a.jsx(ti,{data:te,baseData:n||e,zoom:P,rows:q,ref:T,onTileClick:r,onEventDrop:l,onEventDrag:u,draggableConfig:c,onDragStateChange:E,onTimeRangeSelect:d,onMultiTimeRangeSelect:h,clickToAddConfig:y,separatorRowIndices:U}):a.jsx(Ni,{width:i,children:Z?a.jsx(Mn,{isLoading:Z,position:"left"}):a.jsx(Yi,{})}),$&&F&&!j&&(S==null?void 0:S.resourceIndex)>-1&&a.jsx(Vc,{tooltipData:S})]})]})},Wi=w.div`
  width: 100%;
  display: grid;
...
`,xl=({selections:e,data:n,zoom:t,startDate:r,onRemove:o,onUpdate:s,separatorRowIndices:i=[]})=>{const[l,u]=p.useState(null),[c,d]=p.useState({x:0,y:0}),h=p.useRef(null),y=p.useMemo(()=>{switch(t){case 0:return _e*7;case 1:return ye;case 2:return Ce;default:return ye}},[t]),S=p.useMemo(()=>D().year(r.year).month(r.month).date(r.dayOfMonth).hour(r.hour).minute(0).second(0).millisecond(0),[r]),x=p.useMemo(()=>e.map((m,b)=>{let _=0,P=!1;for(const J of n){if(J.id===m.resourceId){P=!0;break}_+=Math.max(J.data.length,1)}if(!P)return null;const W=D(m.startDate),Z=D(m.endDate);let R,$;switch(t){case 0:R=Math.floor(W.diff(S,"days")/7),$=Math.max(1,Math.ceil(Z.diff(W,"days")/7)+1);break;case 1:R=W.diff(S,"days"),$=Math.max(1,Z.diff(W,"days")+1);break;case 2:R=W.diff(S,"hours"),$=Math.max(1,Z.diff(W,"hours")+1);break;default:R=0,$=1}const A=R*y;let T=0;for(const J of i)J<=_&&T++;const B=_*ue+T*De,Y=$*y;return{index:b,selection:m,x:A,y:B,width:Y,height:ue}}),[e,n,t,S,y]),k=(m,b)=>{const _=D(m).format("MMM D"),P=D(b).format("MMM D");return _===P?_:`${_} - ${P}`},g=m=>!m.hasConflict||!m.conflicts?"":`⚠️ Conflicts with:
