...
`,va=b.div`
  ...
  z-index: 4;
  pointer-events: none;
`,xa=()=>{const{date:e,zoom:r,data:t,goToDate:n}=He(),o=ze(),s=p.useRef(null),[a,l]=p.useState(null),d=p.useMemo(()=>Array.from({length:12},(u,g)=>E().month(g).format("MMM").toUpperCase()),[o]),c=e.year(),f=p.useMemo(()=>E(new Date(c,0,1)),[c]),h=p.useMemo(()=>E(new Date(c+1,0,1)).diff(f,"day"),[c,f]),v=u=>u.diff(f,"day")/h*100,M=p.useMemo(()=>{const u=Math.ceil(h/7),g=new Array(u).fill(0),w=new Array(u).fill(0);for(const A of t??[])for(const N of A.data??[]){const J=E(N.startDate);if(J.year()!==c)continue;const Q=Math.floor(J.diff(f,"day")/7);if(Q<0||Q>=u)continue;g[Q]+=1;const _=N.readiness==="sin_chofer"?2:N.readiness==="sin_avisar"?1:0;_>w[Q]&&(w[Q]=_)}const $=Math.max(1,...g);return g.map((A,N)=>({h:A/$*100,sev:w[N]}))},[t,c,f,h]),x=E(),C=x.year()===c?v(x):null,m=u=>{const{startDate:g,endDate:w}=Nt(u,r),$=Math.max(0,v(g));return{left:$,width:Math.min(100,v(w))-$,startDate:g,endDate:w}},L=m(e),j=a?m(a.d):null,O=u=>`${u.date()} ${d[u.month()]}`,I=u=>{var $;const g=($=s.current)==null?void 0:$.getBoundingClientRect();if(!g)return null;const w=Math.min(1,Math.max(0,(u-g.left)/g.width));return{f:w,d:f.add(Math.round(w*h),"day")}};return i.jsxs(aa,{children:[i.jsxs(ca,{children:["Navegar",i.jsx("br",{}),"por fecha"]}),i.jsxs(la,{ref:s,onClick:u=>{const g=I(u.clientX);g&&n(g.d.toDate())},onMouseMove:u=>{const g=I(u.clientX);g&&l({left:g.f*100,d:g.d})},onMouseLeave:()=>l(null),children:[i.jsx(da,{children:d.map((u,g)=>i.jsx("span",{style:{left:`${v(E(new Date(c,g,1)))}%`},children:u},g))}),d.map((u,g)=>g===0?null:i.jsx(ua,{style:{left:`${v(E(new Date(c,g,1)))}%`}},g)),i.jsx(fa,{children:M.map((u,g)=>i.jsx(ha,{$sev:u.sev,style:{height:`${u.h}%`}},g))}),i.jsx(ga,{style:{left:`${L.left}%`,width:`${L.width}%`}}),C!==null&&i.jsx(pa,{style:{left:`${C}%`},children:i.jsx("span",{children:"HOY"})}),a&&j&&i.jsxs(i.Fragment,{children:[i.jsx(ma,{style:{left:`${j.left}%`,width:`${j.width}%`}}),i.jsx(ya,{style:{left:`${a.left}%`}}),i.jsx(va,{style:{left:`${a.left}%`},children:`${O(j.startDate)} – ${O(j.endDate)}`})]})]})]})},ba=b.div`
  position: absolute;
  inset: 0;
...
`,Sa=b.div`
  position: relative;
`,Ca=({data:e,baseData:r,categories:t,onTileClick:n,topBarWidth:o,onItemClick:s,toggleTheme:a,onEventDrop:l,onEventDrag:d,draggableConfig:c,schedulerRef:f,onTimeRangeSelect:h,onMultiTimeRangeSelect:v,clickToAddConfig:M})=>{const{goToDate:x,handleGoToday:C,zoomIn:m,zoomOut:L,zoom:j}=He();return p.useImperativeHandle(f,()=>({goToDate:x,goToToday:C,setZoom:O=>{if(!xr(O))return;const I=O-j;if(I>0)for(let u=0;u<I;u++)m();else for(let u=0;u<Math.abs(I);u++)L()}}),[x,C,j,m,L]),i.jsx(Xi,{data:e,baseData:r,categories:t,onTileClick:n,topBarWidth:o,onItemClick:s,toggleTheme:a,onEventDrop:l,onEventDrag:d,draggableConfig:c,onTimeRangeSelect:h,onMultiTimeRangeSelect:v,clickToAddConfig:M})},ka=p.forwardRef(function({data:r,categories:t,baseData:n,config:o,startDate:s,onRangeChange:a,onTileClick:l,handleToggleDisplayActiveUnits:d,onClearFilterData:c,toolbarActions:f,onItemClick:h,isLoading:v,onEventDrop:M,onEventDrag:x,draggableConfig:C,onTimeRangeSelect:m,onMultiTimeRangeSelect:L,clickToAddConfig:j},O){var B;const I=p.useMemo(()=>({zoom:0,filterButtonState:1,includeTakenHoursOnWeekendsInDayView:!1,showTooltip:!0,showTopbar:!0,showLegend:!0,translations:void 0,...o}),[o]),u=p.useRef(null),g=p.useRef(null),[w,$]=p.useState((B=u.current)==null?void 0:B.clientWidth),A=p.useMemo(()=>E(s),[s]),[N,J]=p.useState(I.defaultTheme??"light"),Q=()=>{J(N==="light"?"dark":"light")},_=N==="light"?ls:ds,T=I.theme?I.theme[_.mode]:{},P={..._,colors:{..._.colors,...T}};return p.useImperativeHandle(O,()=>({goToDate:Y=>{var U;return(U=g.current)==null?void 0:U.goToDate(Y)},goToToday:()=>{var Y;return(Y=g.current)==null?void 0:Y.goToToday()},setZoom:Y=>{var U;return(U=g.current)==null?void 0:U.setZoom(Y)}}),[]),p.useLayoutEffect(()=>{const Y=()=>{u.current&&$(u.current.clientWidth)};return Y(),window.addEventListener("resize",Y),()=>window.removeEventListener("resize",Y)},[]),i.jsxs(i.Fragment,{children:[i.jsx(cs,{}),i.jsx(ss,{theme:P,children:i.jsx(Ni,{lang:I.lang,translations:I.translations,children:i.jsx(ei,{data:r,isLoading:!!v,config:I,onRangeChange:a,defaultStartDate:A,handleToggleDisplayActiveUnits:d,onClearFilterData:c,toolbarActions:f,children:i.jsxs(ba,{id:hr,children:[i.jsx(wa,{showScroll:!!r.length,$footer:I.showOverview!==!1&&!!r.length,id:Be,ref:u,children:i.jsx(Sa,{children:i.jsx(Ca,{data:r,baseData:n,categories:t,onTileClick:l,topBarWidth:w??0,onItemClick:h,toggleTheme:Q,onEventDrop:M,onEventDrag:x,draggableConfig:C,schedulerRef:g,onTimeRangeSelect:m,onMultiTimeRangeSelect:L,clickToAddConfig:j})})}),I.showOverview!==!1&&!!r.length&&i.jsx(xa,{})]})})})})]})}),Ma=b.div`
  padding: 4px 11px 0;
  width: 100%;
...
`,Ea=b.p`
  ...
  width: 100%;
  text-align: center;
`,Or=({intent:e,onClick:r,icon:t,isVisible:n,pageNum:o,pagesAmount:s})=>{const{loadNext:a,loadPrevious:l}=ze(),d=e==="next"?`${a} ${o+2}/${s}`:`${l} ${o}/${s}`;return i.jsx(Ma,{intent:e,children:i.jsxs($a,{onClick:r,isVisible:n,children:[t&&i.jsx(Da,{children:t}),i.jsx(Ea,{children:d})]})})},_a=b.div`
  min-width: ${Ae+"px"};
  max-width: ${Ae+"px"};
  min-height: 100vh;
  position: sticky;
...
`,Dn=({isLoading:e,position:r})=>e?i.jsx(qa,{position:r,children:i.jsx(Qa,{})}):null,We=(e,r)=>{const{ctx:t,x:n,y:o,width:s,height:a,textYPos:l,label:d,font:c,isBottomRow:f,fillStyle:h,topText:v,bottomText:M,strokeStyle:x,labelBetweenCells:C}=e;if(t.beginPath(),t.strokeStyle=x??r.colors.border,t.setLineDash([]),d&&c&&l){t.fillStyle=r.colors.gridBackground,t.fillRect(n,o,s,a),C?(t.moveTo(n,o),t.lineTo(n+s,o),t.stroke(),t.moveTo(n,o+a),t.lineTo(n+s,o+a),t.stroke(),t.moveTo(n+s/2,o+a),t.lineTo(n+s/2,o+a-5),t.stroke()):t.strokeRect(n+.5,o+.5,s,a),t.font=c;const m=n+s/2-t.measureText(d).width/2;t.textBaseline="middle",t.fillStyle=r.colors.accent,t.fillText(d,m,l)}if(f&&h&&v&&M){t.fillStyle=h,t.fillRect(n,o,s,a),t.strokeRect(n+.5,o+.5,s,a),t.font=v.font;const m=n+s/2-t.measureText(v.label).width/2;t.fillStyle=v.color,t.fillText(v.label,m,v.y),t.font=M.font;const L=n+s/2-t.measureText(M.label).width/2;t.fillStyle=M.color,t.fillText(M.label,L,M.y)}},En=(e,r)=>{const{isCurrent:t,isBusinessDay:n,variant:o}=e;return t?o==="bottomRow"?r.colors.placeholder:r.colors.accent:n?o==="bottomRow"?r.colors.placeholder:r.colors.textPrimary:r.colors.placeholder},Ra=(e,r,t,n)=>{const o=it-qe/fs,s=it-qe/hs,a=Fe+st;let l=0;for(let d=0;d<r;d++){const c=mr(E(`${t.year}-${t.month+1}-${t.dayOfMonth}`).add(d,"days")),f=c.isCurrentDay;if(We({ctx:e,x:l,y:a,width:Se,height:qe,isBottomRow:!0,fillStyle:f?n.colors.currentDay:c.isBusinessDay?n.colors.gridBackground:n.colors.primary,topText:{y:o,label:f?"":c.dayName.toUpperCase(),font:Ye.bottomRow.name,color:En({isCurrent:!1,isBusinessDay:c.isBusinessDay},n)},bottomText:{y:s,label:`${c.dayOfMonth}`,font:f?`700 10px ${Ie}`:Ye.bottomRow.number,color:f?n.colors.today:En({isCurrent:!1,isBusinessDay:c.isBusinessDay,variant:"bottomRow"},n)}},n),f){const M=l+Se/2,x=o-13/2;e.save(),e.fillStyle=n.colors.today,e.beginPath(),e.roundRect?e.roundRect(M-30/2,x,30,13,5):e.rect(M-30/2,x,30,13),e.fill(),e.fillStyle="#fff",e.font=`800 8.5px ${Ie}`,e.textAlign="center",e.textBaseline="middle",e.fillText("HOY",M,x+13/2+.5),e.restore()}l+=Se}},ec=(e,r,t,n)=>{let o=-(t.dayOfMonth-1)*Pe;const s=Fe;let l=t.month;for(let d=0;d<r;d++){l>=rn&&(l=0);const c=gr(t,d)*Pe;We({ctx:e,x:o,y:s,width:c,height:st,textYPos:dr,label:E().month(l).format("MMMM").toUpperCase(),font:Ye.bottomRow.number},n),o+=c,l++}},tc=(e,r,t)=>{let o=0,s=0,a=E(`${r.year}-${r.month+1}-${r.dayOfMonth}`).month();o=-r.dayOfMonth*Se+Se;for(let l=0;l<rn;l++)a>rn-1&&(a=0),s=E(`${r.year}-${r.month+1}-${r.dayOfMonth}`).add(l,"months").daysInMonth()*Se,We({ctx:e,x:o,y:0,width:s,height:Fe,textYPos:sn,label:E(`${r.year}-${r.month+1}-${r.dayOfMonth}`).month(a).format("MMMM YYYY").toUpperCase()+`                                                                                                  ${E(`${r.year}-${r.month+1}-${r.dayOfMonth}`).month(a).format("MMMM YYYY").toUpperCase()}`,font:Ye.topRow},t),o+=s,a++},nc=(e,r,t,n)=>{const o=7*Se,s=Fe,a=e.canvas.width/o+o,l=r.weekOfYear;let d=0;for(let c=0;c<a;c++){const f=E(`${r.year}-${r.month+1}-${r.dayOfMonth}`).day();let h=(l+c)%ar;h<=0&&(h+=ar),f!==1&&c===0&&(d=-f*Se+Se),We({ctx:e,x:d,y:s,width:o,height:st,textYPos:dr,label:`${t.toUpperCase()} ${h}`,font:Ye.middleRow},n),d+=o}},rc=(e,r)=>{const{isCurrent:t,isBusinessDay:n,variant:o}=e;return o==="yearView"?t?r.colors.tertiary:r.colors.gridBackground:t?r.colors.currentDay:n?r.colors.primary:r.colors.secondary},oc=(e,r,t,n,o)=>{const s=it-qe/1.6,a=it-qe/4.5,l=Fe+st;let d=0;for(let c=0;c<r;c++){const f=E(`${t.year}-${t.month+1}-${t.dayOfMonth}`).add(c,"weeks"),h=f.isSame(E(),"week");We({ctx:e,x:d,y:l,width:at,height:qe,isBottomRow:!0,fillStyle:h?o.colors.today+"26":rc({isCurrent:h,variant:"yearView"},o),topText:{y:s,label:f.isoWeek().toString(),font:h?`700 14px ${Ie}`:Ye.bottomRow.name,color:h?o.colors.today:En({isCurrent:h},o)},bottomText:{y:a,label:n.toUpperCase(),font:Ye.middleRow,color:o.colors.placeholder}},o),d+=at}},sc=(e,r,t,n)=>{const s=r.year,a=e.canvas.width*2;let l=0,d=0,c=(pr(s)-t+1)*Pe,f=0;for(;l+f<=a;)d>0&&(c=pr(s+d)*Pe),f+c>a&&d>0&&(c=Math.ceil((a-f)/Pe)*Pe),We({ctx:e,x:l,y:0,width:c,height:Fe,textYPos:sn,label:(s+d).toString(),font:Ye.topRow},n),l+=c,f+=c,d++},ic=(e,r,t,n)=>{const o=Math.floor(r/It)+2,s=It*Me;let d=-E(`${t.year}-${t.month+1}-${t.dayOfMonth}T${t.hour}:00:00`).hour()*Me+.5*Me;for(let c=0;c<o;c++){const f=E(`${t.year}-${t.month+1}-${t.dayOfMonth}`).add(c,"day").format("dddd DD/MM/YYYY").toUpperCase();We({ctx:e,x:d,y:ct,width:s,height:bt,textYPos:ct+bt/2+2,label:f,font:Ye.bottomRow.number},n),d+=s}},ac=(e,r,t,n)=>{const o=Math.ceil(r/It),s=E(`${t.year}-${t.month+1}-${t.dayOfMonth}`),a=s.add(o-1,"days"),l=s.month(),d=a.add(1,"day").month(),c=l===d?1:2;let f=.5*Me;for(let h=0;h<c;h++){const v=E(`${t.year}-${t.month+1}-${t.dayOfMonth}T${t.hour}:00:00`),x=E(`${t.year}-${t.month+h+1}-01T:23:59:59`).endOf("month"),C=x.format("MMMM").toUpperCase(),m=x.diff(v,"hour")+1,L=h===0?m*Me:r*Me;We({ctx:e,x:f,y:0,width:L,height:ct,textYPos:sn,label:C,font:Ye.topRow},n),f+=L}},cc=(e,r,t,n)=>{let o=0;const s=ct+bt,a=E(`${t.year}-${t.month+1}-${t.dayOfMonth}T${t.hour}:00:00`),l=Me;for(let d=0;d<r;d++){const c=a.add(d,"hours").format("h:00a").toUpperCase();We({ctx:e,x:o,y:s,width:l,height:nn,label:c,font:Ye.bottomRow.hoursInDay,textYPos:ct+bt+nn/2+2,labelBetweenCells:!0},n),o+=Me}},lc=(e,r,t,n,o,s,a)=>{switch(r){case 0:sc(e,n,s,a),ec(e,t,n,a),oc(e,t,n,o,a);break;case 1:tc(e,n,a),nc(e,n,o,a),Ra(e,t,n,a);break;case 2:ac(e,t,n,a),ic(e,t,n,a),cc(e,t,n,a);break}},dc=b.div`
  position: sticky;
  top: 0;
...
`,Lc=34,Nc={sin_chofer:{stripe:"#9AA4B2",icon:"warn",color:"#9AA4B2"},sin_avisar:{stripe:"#D98A22",icon:"warn",color:"#D98A22"},notificado:{stripe:"#2C6BB0",icon:"clock",color:"#2C6BB0"},confirmado:{stripe:"#2E8B63",icon:"check",color:"#2E8B63"}},Fc="#3E8E5A",Bc="#D98A22",Vr=({row:e,data:r,zoom:t,isSubcontract:n=!1,onTileClick:o,onDragStart:s,isDragging:a=!1,isDraggable:l=!0,yOffset:d=0,exiting:c=!1})=>{const{date:f}=He(),h=Nt(f,t),{y:v,x:M,width:x}=Mc(e,h.startDate,h.endDate,r.startDate,r.endDate,t),{colors:C}=Ot(),m=p.useRef(null),L=E(r.startDate).isSame(E(r.endDate),"day"),j=r.eventType===wt.Tour,O=r.eventType===wt.Transfer,I=L&&(j||O),u=Q=>{m.current={x:Q.clientX,y:Q.clientY},l&&s&&(Q.preventDefault(),s(r,Q))},g=Q=>{if(m.current){const _=Math.abs(Q.clientX-m.current.x),T=Math.abs(Q.clientY-m.current.y);Math.sqrt(_*_+T*T)<=5&&(o==null||o(r)),m.current=null}else o==null||o(r)},w={left:`${M}px`,top:`${v+d}px`,backgroundColor:`${r.bgColor??C.defaultTile}`,width:`${x}px`,color:Br(r.bgColor??"")},$=!n&&r.readiness?Nc[r.readiness]:null,A=n&&r.subcontractConfirmed===!1,N=n?A?Bc:Fc:$==null?void 0:$.stripe,J=Q=>i.jsxs(Dc,{"data-segment-id":r.segmentId,style:w,onClick:g,onMouseDown:u,onDragStart:_=>_.preventDefault(),isDraggable:l,isDragging:a,$unconfirmed:A,$exiting:c,children:[N&&i.jsx(Ec,{style:{background:N}}),Q]});return J(I?i.jsxs(i.Fragment,{children:[(n||$)&&i.jsx(zr,{$sm:!0,children:n?i.jsx(jr,{children:"SUB"}):$&&i.jsx(Wr,{$sm:!0,style:{color:$.color},children:i.jsx(je,{name:$.icon,strokeWidth:$.icon==="check"?2.6:2.2})})}),i.jsxs(Yc,{$transfer:O,children:[i.jsx(je,{name:O?"transfer":"sun",strokeWidth:2.4}),x>=Lc&&i.jsxs(i.Fragment,{children:[i.jsx(Zr,{children:E(r.startDate).format("HH:mm")}),!O&&i.jsx(Zr,{$end:!0,children:E(r.endDate).format("HH:mm")})]})]})]}):i.jsxs(i.Fragment,{children:[i.jsx(zr,{children:n?i.jsx(jr,{children:"SUB"}):$&&i.jsx(Wr,{style:{color:$.color},children:i.jsx(je,{name:$.icon,strokeWidth:$.icon==="check"?2.6:2.2})})}),r.bookingNumber&&i.jsx(Oc,{children:r.bookingNumber}),i.jsxs(_c,{children:[i.jsxs(Hr,{$pad:!0,children:[i.jsx(Tc,{children:i.jsx(je,{name:O?"transfer":"tour"})}),i.jsx(Ac,{children:r.title})]}),r.subtitle&&i.jsx(Hr,{children:i.jsx(Pc,{children:r.subtitle})}),r.driver&&i.jsxs(Ic,{children:[i.jsx(je,{name:"person"}),r.driver]})]})]}))},Gr=(e,r)=>{let t=0;for(const n of r)e>=n&&t++;return t*Te},Hc=Ke`
  from { opacity: 0; }
  to { opacity: 1; }
`,zc=b.div`
  position: absolute;
  ...
  pointer-events: none;
`,Wc=({data:e,zoom:r,onTileClick:t,onDragStart:n,isDraggable:o,draggingEventId:s,separatorRowIndices:a=[]})=>{const{nodes:l,liveMap:d}=p.useMemo(()=>{const x=new Map;let C=0;return{nodes:e.map((L,j)=>{if(j>0&&(C+=Math.max(e[j-1].data.length,1)),!L.data.some(O=>O.length>0)){const O=Gr(C,a);return[i.jsx(zc,{style:{top:`${C*fe+O}px`},children:"Disponible"},`dispo-${L.id}`)]}return L.data.map((O,I)=>O.map(u=>{const g=s===u.segmentId,w=o?o(u):!1,$=I+C,A=Gr($,a);return x.set(u.segmentId,{project:u,absoluteRow:$,yOffset:A,isSubcontract:!!L.isSubcontract}),i.jsx(Vr,{row:$,data:u,zoom:r,isSubcontract:L.isSubcontract,onTileClick:t,onDragStart:n,isDragging:g,isDraggable:w,yOffset:A},u.segmentId)}))}).flat(2),liveMap:x}},[e,t,r,n,o,s,a]),c=p.useRef(new Map),f=p.useRef([]),[h,v]=p.useState([]);p.useEffect(()=>()=>f.current.forEach(clearTimeout),[]),p.useEffect(()=>{const x=c.current;c.current=d;const C=[];if(x.forEach((j,O)=>{d.has(O)||C.push(j)}),v(j=>{let O=j.filter(I=>!d.has(I.project.segmentId));for(const I of C)O.some(u=>u.project.segmentId===I.project.segmentId)||(O=[...O,I]);return O}),!C.length)return;const m=new Set(C.map(j=>j.project.segmentId)),L=setTimeout(()=>{v(j=>j.filter(O=>!m.has(O.project.segmentId)))},220);f.current.push(L)},[d]);const M=h.filter(x=>!d.has(x.project.segmentId)).map(x=>i.jsx(Vr,{row:x.absoluteRow,data:x.project,zoom:r,isSubcontract:x.isSubcontract,yOffset:x.yOffset,isDragging:!1,isDraggable:!1,exiting:!0},x.project.segmentId));return i.jsx(i.Fragment,{children:[...l,...M]})};b.div`
  box-sizing: border-box;
  font-family: ${Ie};
  padding: 0 0.5rem;
  height: 125px;
...
`,kt=b.div`
  ...
  max-height: 60px;
  overflow-y: auto;
`;b.div``,b.span``,b.span``,b.div``,b.div``,b.span``,b.span``,b.div``,b.div``,b.span``,b.span``,b.div``,b.div``,b.div``,b.span``,b.div``,b.div``,b.div``,b.div``,b.p``,b.span``;const nl={client:"Client",startDate:"Start",endDate:"End",groupName:"Group",driver:"Driver",flightNumber:"Flight",serviceNotes:"Service Notes",reservationNotes:"Reservation Notes",salida:"Salida",destino:"Destino",regreso:"Regreso",tour:"Tour",transfer:"Transfer",oneDay:"One-day",passengers:"Pax"},rl=({tooltipData:e,visible:r=!0})=>{const{mouseCoords:t,reservationData:n}=e,o=p.useRef(null),[s,a]=p.useState("below"),l=ze(),d={...nl,...l.tooltip};p.useLayoutEffect(()=>{if(!o.current||!t)return;const x=o.current,{width:C,height:m}=x.getBoundingClientRect(),L=x.parentElement;if(!L)return;const j=L.getBoundingClientRect(),O=12,I=4,u=j.height-t.y,g=j.width-t.x;let w=t.x+O,$=t.y+O,A="below";g<C+O&&(w=t.x-C-O),u<m+O&&($=t.y-m-O,A="above"),w=Math.max(I,Math.min(w,j.width-C-I)),$=Math.max(I,Math.min($,j.height-m-I)),a(A),x.style.left=`${w}px`,x.style.top=`${$}px`},[t]);const c=n.reservationType===wt.Tour,f=c&&n.isOneDayEvent,h=()=>c?f?"oneday":"tour":"transfer",v=()=>c?f?d.oneDay:d.tour:d.transfer,M=[n.groupName&&{label:d.groupName,value:n.groupName},n.driver&&{label:d.driver,value:n.driver},n.passengers&&{label:d.passengers,value:String(n.passengers)},n.flightNumber&&{label:d.flightNumber,value:n.flightNumber}].filter(Boolean);return i.jsxs(jc,{ref:o,$position:s,$visible:r,children:[i.jsxs(Zc,{children:[i.jsxs(Vc,{children:[i.jsx(Gc,{children:n.bookingNumber}),i.jsx(Xc,{$type:h(),children:v()})]}),i.jsx(Uc,{children:n.eventName}),n.client&&i.jsx(Kc,{children:n.client})]}),i.jsxs(qc,{children:[i.jsxs(Jc,{children:[i.jsxs(Xr,{children:[i.jsx(Ur,{children:d.startDate}),i.jsxs(Kr,{children:[i.jsx(qr,{children:n.startDate})," ",i.jsx(Jr,{children:n.startTime})]})]}),c&&n.endDate&&i.jsxs(Xr,{$isEnd:!0,children:[i.jsx(Ur,{children:d.endDate}),i.jsxs(Kr,{children:[i.jsx(qr,{children:n.endDate})," ",i.jsx(Jr,{children:n.endTime})]})]})]}),M.length>0&&i.jsx(Qc,{children:M.map((x,C)=>i.jsxs(Rc,{children:[i.jsx(el,{children:x.label}),i.jsx(tl,{children:x.value})]},C))}),(n.departureAddress||n.destinationAddress||n.returnAddress)&&i.jsxs(Qr,{children:[n.departureAddress&&i.jsxs(St,{children:[i.jsx(Ct,{children:d.salida}),i.jsx(kt,{children:n.departureAddress})]}),n.destinationAddress&&i.jsxs(St,{children:[i.jsx(Ct,{children:d.destino}),i.jsx(kt,{children:n.destinationAddress})]}),n.returnAddress&&i.jsxs(St,{children:[i.jsx(Ct,{children:d.regreso}),i.jsx(kt,{children:n.returnAddress})]})]}),(n.serviceNotes||n.reservationNotes)&&i.jsxs(Qr,{children:[n.serviceNotes&&i.jsxs(St,{children:[i.jsx(Ct,{children:d.serviceNotes}),i.jsx(kt,{children:n.serviceNotes})]}),n.reservationNotes&&i.jsxs(St,{children:[i.jsx(Ct,{children:d.reservationNotes}),i.jsx(kt,{children:n.reservationNotes})]})]})]})]})};b.div`
  display: flex;
  align-items: center;
  cursor: pointer;
  width: 60px;
...
`,pl=({draggedEvent:e,ghostPosition:r,ghostDimensions:t,dropTarget:n,isValidDrop:o,dragState:s,data:a,resourceOnly:l,separatorRowIndices:d=[]})=>{const c=ze(),f=I=>{let u=0;for(const g of d)g<=I&&u++;return I*fe+u*Te},[h,v]=p.useState(null),[M,x]=p.useState(0),C=p.useCallback((I=400,u=300)=>{const w=t.width,$=48,A=document.getElementById("react-scheduler");if(!A)return{x:r.x+w+16,y:r.y};const N=A.scrollLeft,J=A.scrollTop,Q=A.clientWidth,_=A.clientHeight,T=r.x-N,P=r.y-J,B={left:Ae+16,right:Q-16,top:16,bottom:_-16},Y=B.right-(T+w),U=T-B.left,R=B.bottom-(P+$),ie=P-B.top;let ce,F;return Y>=I+16?ce=T+w+16:U>=I+16?ce=T-I-16:Y>=U?(ce=T+w+16,ce+I>B.right&&(ce=B.right-I)):(ce=T-I-16,ce<B.left&&(ce=B.left)),R>=u+16?F=P+$+16:ie>=u+16?F=P-u-16:R>=ie?(F=P+$+16,F+u>B.bottom&&(F=B.bottom-u)):(F=P-u-16,F<B.top&&(F=B.top)),ce=Math.max(B.left,Math.min(ce,B.right-I)),F=Math.max(B.top,Math.min(F,B.bottom-u)),{x:ce+N,y:F+J}},[r.x,r.y,t.width]);p.useEffect(()=>{s==="dragging"&&e&&M===0?x(r.x):s==="idle"&&x(0)},[s,e,r.x,M]),p.useEffect(()=>{v(s==="animating"&&e?{x:0,y:0}:null)},[s,e]);const m=p.useMemo(()=>{if(!e||!e.totalPassengers||s==="idle"||s==="potential")return[];const I=[];let u=0;for(const g of a){const w=Math.max(g.data.length,1);if(g.capacity!==void 0&&e.totalPassengers>g.capacity)for(let $=0;$<w;$++)I.push(u+$);u+=w}return I},[e,a,s]);if(!e||s==="idle"||s==="potential")return null;const L=s==="animating",j=Br(e.bgColor??""),O=()=>{if(!n)return"";const I=E(n.startDate).format("MMM D, HH:mm"),u=E(n.endDate).format("HH:mm");return`${I} - ${u}`};return i.jsxs(ol,{children:[m.map(I=>i.jsx(fl,{style:{top:`${f(I)}px`,height:`${fe}px`}},I)),n&&s==="dragging"&&i.jsx(ul,{$isValid:o,$hasConflict:n.hasConflict,style:{top:`${f(n.resourceIndex)}px`,height:`${fe}px`}}),n&&s==="dragging"&&!l&&i.jsxs(i.Fragment,{children:[i.jsx(ll,{$isValid:o,$hasConflict:n.hasConflict,style:{left:`${r.x}px`,top:`${f(n.resourceIndex)+(fe-48)/2}px`,width:`${t.width}px`}}),i.jsx(dl,{$isValid:o,$hasConflict:n.hasConflict,style:{left:`${r.x}px`,top:`${f(n.resourceIndex)+(fe-48)/2}px`},children:O()})]}),n&&s==="dragging"&&l&&i.jsx(hl,{$isValid:o,$hasConflict:n.hasConflict,style:{left:"0px",top:`${f(n.resourceIndex)}px`,height:`${fe}px`}}),n&&o&&n.hasConflict&&n.conflicts&&n.conflicts.length>0&&s==="dragging"&&(()=>{const I=C(400,300);return i.jsxs(eo,{style:{left:`${I.x}px`,top:`${I.y}px`},children:[i.jsxs(to,{children:[i.jsx(no,{children:"!"}),n.conflicts.length," ",n.conflicts.length>1?c.conflicts.detectedPlural:c.conflicts.detected," ",c.conflicts.detectedSuffix]}),i.jsx(ro,{children:n.conflicts.map((u,g)=>{const w=E(n.startDate).format("YYYY-MM-DD"),$=E(n.endDate).format("YYYY-MM-DD"),A=E(u.event.startDate).format("YYYY-MM-DD"),N=E(u.event.endDate).format("YYYY-MM-DD"),J=E(u.conflictStart).format("YYYY-MM-DD"),Q=E(u.conflictEnd).format("YYYY-MM-DD"),_=w!==$,T=A!==N,P=J!==Q,B=_?E(n.startDate).format("MMM D, h:mm A"):E(n.startDate).format("h:mm A"),Y=_?E(n.endDate).format("MMM D, h:mm A"):E(n.endDate).format("h:mm A"),U=T?E(u.event.startDate).format("MMM D, h:mm A"):E(u.event.startDate).format("h:mm A"),R=T?E(u.event.endDate).format("MMM D, h:mm A"):E(u.event.endDate).format("h:mm A"),ie=P?E(u.conflictStart).format("MMM D, h:mm A"):E(u.conflictStart).format("h:mm A"),ce=P?E(u.conflictEnd).format("MMM D, h:mm A"):E(u.conflictEnd).format("h:mm A"),F=P?"":E(u.conflictStart).format("MMM D"),H=n.startDate.getTime(),q=n.endDate.getTime(),ne=u.event.startDate.getTime(),k=u.event.endDate.getTime(),z=H>=ne&&H<k,S=q>ne&&q<=k,V=H<=ne&&q>=k,G=ne<=H&&k>=q;let W=!1,y=!1,X=!1,D=!1,Z="";return V||G?(W=!0,y=!0,X=!0,D=!0,Z=`⚠️ ${c.conflicts.changeBoth}`):z&&S?(W=!0,y=!0,X=!0,D=!0,Z=`⚠️ ${c.conflicts.changeBoth}`):z?(W=!0,D=!0,Z=`⚠️ ${c.conflicts.changeStart}`):S&&(y=!0,X=!0,Z=`⚠️ ${c.conflicts.changeEnd}`),i.jsxs(_n,{children:[i.jsxs(Tn,{children:[c.conflicts.conflictsWith,": ",u.event.title,u.event.subtitle&&` - ${u.event.subtitle}`]}),i.jsxs(ht,{children:[i.jsx("strong",{children:e.title})," ",c.conflicts.movingTo,":"," ",W?i.jsx("span",{style:{color:"#D32F2F",fontWeight:700},children:B}):B," ",c.conflicts.to," ",y?i.jsx("span",{style:{color:"#D32F2F",fontWeight:700},children:Y}):Y]}),i.jsxs(ht,{children:[i.jsx("strong",{children:u.event.title})," ",c.conflicts.currentlyAt,":"," ",X?i.jsx("span",{style:{color:"#D32F2F",fontWeight:700},children:U}):U," ",c.conflicts.to," ",D?i.jsx("span",{style:{color:"#D32F2F",fontWeight:700},children:R}):R]}),i.jsxs(oo,{children:[c.conflicts.conflictTime,": ",F&&`${F}, `,ie," - ",ce]}),Z&&i.jsx(ht,{style:{backgroundColor:"#FFEBEE",color:"#C62828",fontWeight:600,marginTop:"6px",border:"1px solid #EF5350"},children:Z})]},g)})})]})})(),n&&o&&!n.hasConflict&&n.nearbyEvents&&n.nearbyEvents.length>0&&s==="dragging"&&(()=>{const I=C(400,400);return i.jsxs(eo,{style:{left:`${I.x}px`,top:`${I.y}px`,borderColor:"#4CAF50"},children:[i.jsxs(to,{style:{color:"#2E7D32"},children:[i.jsx(no,{style:{backgroundColor:"#4CAF50"},children:"✓"}),n.nearbyEvents.length," ",n.nearbyEvents.length>1?c.conflicts.nearbyEvents:c.conflicts.nearbyEvent]}),i.jsxs(ro,{children:[(()=>{const u=n.nearbyEvents.some(A=>A.position==="before"),g=n.nearbyEvents.some(A=>A.position==="after"),w=E(n.startDate).format("h:mm A"),$=E(n.endDate).format("h:mm A");return i.jsxs(_n,{style:{backgroundColor:"#F1F8E9",borderLeftColor:"#8BC34A"},children:[i.jsxs(Tn,{style:{color:"#33691E"},children:[c.conflicts.yourEvent,": ",e.title,e.subtitle&&` - ${e.subtitle}`]}),i.jsxs(ht,{style:{fontWeight:600},children:[E(n.startDate).format("MMM D"),":"," ",u?i.jsx("span",{style:{color:"#2E7D32",fontWeight:700},children:w}):w," ",c.conflicts.to," ",g?i.jsx("span",{style:{color:"#2E7D32",fontWeight:700},children:$}):$]}),i.jsx(ht,{style:{backgroundColor:"#DCEDC8",marginTop:"4px",fontSize:"10px",color:"#558B2F"},children:c.conflicts.sameDay})]})})(),n.nearbyEvents.map((u,g)=>{const w=E(u.event.startDate).format("YYYY-MM-DD"),$=E(u.event.endDate).format("YYYY-MM-DD"),A=w!==$,N=A?E(u.event.startDate).format("MMM D, h:mm A"):E(u.event.startDate).format("h:mm A"),J=A?E(u.event.endDate).format("MMM D, h:mm A"):E(u.event.endDate).format("h:mm A"),Q=E(u.event.startDate).format("MMM D"),_=Math.floor(u.timeGap/(1e3*60*60)),T=Math.floor(u.timeGap%(1e3*60*60)/(1e3*60)),P=_>0?`${_}h ${T}m`:`${T}m`,B=u.position==="after",Y=u.position==="before";return i.jsxs(_n,{style:{backgroundColor:"#E8F5E9",borderLeftColor:"#4CAF50"},children:[i.jsxs(Tn,{style:{color:"#1B5E20"},children:[u.event.title,u.event.subtitle&&` - ${u.event.subtitle}`]}),i.jsxs(ht,{children:[!A&&`${Q}: `,B?i.jsx("span",{style:{color:"#2E7D32",fontWeight:700},children:N}):N," ",c.conflicts.to," ",Y?i.jsx("span",{style:{color:"#2E7D32",fontWeight:700},children:J}):J]}),i.jsxs(oo,{style:{backgroundColor:"#C8E6C9",borderColor:"#4CAF50",color:"#1B5E20"},children:[P," ",u.position==="before"?c.conflicts.before:c.conflicts.after]})]},g)})]})]})})(),i.jsx(sl,{$isAnimating:L,$animateToX:h==null?void 0:h.x,$animateToY:h==null?void 0:h.y,style:{left:L?`${(h==null?void 0:h.x)??0}px`:"0",top:L?`${(h==null?void 0:h.y)??0}px`:"0",transform:L?void 0:`translate3d(${l?M:r.x}px, ${r.y}px, 0)`,backgroundColor:e.bgColor??"rgb(114, 141, 226)",width:`${t.width}px`,color:j},children:i.jsx(il,{children:i.jsxs(cl,{children:[i.jsx(Rr,{$bold:!0,children:e.title}),e.subtitle&&i.jsx(Rr,{children:e.subtitle}),e.description&&i.jsx(al,{children:e.description})]})})})]})},gl=Ke`
  0% {
...
`,so=b.button`
  ...
  `}
`,Ml=({selections:e,onConfirm:r,onClear:t})=>{var x;const o=ze().multiSelect,s=p.useMemo(()=>e.filter(C=>C.hasConflict).length,[e]),a=e.length===1?(o==null?void 0:o.selectionPending)||"selection pending":(o==null?void 0:o.selectionsPending)||"selection(s) pending",l=`${(o==null?void 0:o.clickToRemove)||"Click × on selections to remove"} • ${(o==null?void 0:o.pressEscToClear)||"Press Esc to clear all"}`,d=(o==null?void 0:o.clearAll)||"Clear All",c=e.length===1?(o==null?void 0:o.confirmSelection)||"Confirm Selection":(o==null?void 0:o.confirmSelections)||"Confirm Selections",f=e.length===1?(o==null?void 0:o.confirmWithConflict)||"Confirm with Conflict":(o==null?void 0:o.confirmWithConflicts)||"Confirm with Conflicts",h=s===1?(o==null?void 0:o.conflictWarning)||"1 selection has conflicts":((x=o==null?void 0:o.conflictsWarning)==null?void 0:x.replace("{count}",String(s)))||`${s} selections have conflicts`;if(e.length===0)return null;const v=s>0,M=i.jsxs(xl,{$hasConflicts:v,"data-multi-select-ui":!0,children:[i.jsxs(bl,{children:[i.jsxs(wl,{$hasConflicts:v,children:[e.length," ",a]}),v&&i.jsxs(Sl,{children:["⚠️ ",h]}),i.jsx(Cl,{children:l})]}),i.jsxs(kl,{children:[i.jsxs(so,{variant:"secondary",onClick:t,children:["✕ ",d]}),i.jsx(so,{variant:"primary",$hasConflicts:v,onClick:r,children:v?`⚠️ ${f}`:`✓ ${c}`})]})]});return ao.createPortal(M,document.body)},$l=Ke`
  from {
    opacity: 0;
    transform: scale(0.95);
  }
...
`,Ol=({zoom:e,startDate:r})=>{const{cols:t}=He(),n=p.useMemo(()=>{if(e===2)return null;const o=e===0?Pe*7:Se,s=E().year(r.year).month(r.month).date(r.dayOfMonth).startOf("day"),a=E().startOf("day"),l=e===0?a.startOf("week").diff(s.startOf("week"),"week"):a.diff(s,"days");return l<0||l>=t?null:{x:l*o,width:o}},[e,r,t]);return n?i.jsx(Pl,{style:{left:`${n.x}px`,width:`${n.width}px`},"aria-hidden":!0}):null},ud="";Ee.Scheduler=ka,Object.defineProperty(Ee,Symbol.toStringTag,{value:"Module"})});
